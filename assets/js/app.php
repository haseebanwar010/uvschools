...
var base_url = "https://"+window.location.host+"/uv/master/";
...
//    today = dd + '/' + mm + '/' + yyyy;
    ...
    $scope.permissions = [
      ...
      // academic settings
        ...
        {label: '<?php echo lang("monitoring-index");?>', permission: 'monitoring-index', val: false},
        {label: 'Class Levels', permission: 'class-levels', val: false},
        {label: 'Classes', permission: 'emp-classes', val: false},
        {label: 'Sections', permission: 'emp-sections', val: false},
        {label: 'Subjects', permission: 'emp-subjects', val: false},
        {label: 'Subject Groups', permission: 'emp-subject-groups', val: false},
        {label: 'Assign Teachers', permission: 'emp-assign-teachers', val: false},
        {label: 'Periods', permission: 'emp-periods', val: false},
      ...
      // general setting
        ...
        {label: '<?php echo lang("announcements-index");?>', permission: 'announcements-index', val: false},
        {label: '<?php echo lang("messages-employee");?>', permission: 'messages-employee', val: false},
        {label: '<?php echo lang("messages-parent");?>', permission: 'messages-parent', val: false},
        {label: '<?php echo lang("messages-student");?>', permission: 'messages-student', val: false},
      ...
      // examination       
        ...
        {label: '<?php echo lang("examination-publish_result");?>', permission: 'examination-publish_result', val: false},
      ...
      // Fee
        ...
        {"label": '<?php echo lang("fee-disable");?>', "permission": "fee-disable", "val": false},
        {"label": '<?php echo lang("fee-exemption");?>', "permission": "fee-exemption", "val": false},
        {"label": '<?php echo lang("fee-discounts");?>', "permission": "fee-discounts", "val": false},
    ...
    $scope.onSubmit = function (valid) {
        ...
        $scope.formModel.contact=final_countryPhone;
        $scope.formModel.u_phone_number=cntry_phone1;
        $scope.formModel.parent_phone_code=$('#parent_phone_code').val();
...
//    today = dd + '/' + mm + '/' + yyyy;
    ...
    $scope.onSubmit = function (valid) {
        ...
        if (valid) {
            ...
            $scope.formModel.phone=final_countryPhone;
            $scope.formModel.u_phone_number=cntry_phone1;
            $scope.formModel.parent_phone_code=$('#parent_phone_code').val();
        ...
        $http.post(base_url + "messages/startConversation/", $scope.message).then(
                function (response) {
                    ...
                    if (response.data.success) {
                        ...
                        var otherData = {};
                        publicNotificationViaPusher('new_conversation', otherData, response.data.part, 'messages/view/' + response.data.con_id, 'https://uvschools.com/restapis/api/conversation_detail', response.data.con_id, {'sender': response.data.sender});
    ...
    $scope.fetchStudent = function (id) {
        $http.post(base_url + 'students/getStudent', {'student_id': id}, config).then(
                ...
                function (success) {
                    ...
                    var u_phn_num=$scope.formModel.u_phone_number;
                    var complete_phone=$scope.formModel.phone;
                    ...
                    globalval= success.data.parent_phone_code;
                    var input5 = document.querySelector("#phone");
                    var iti5 = window.intlTelInput(input5, {
                    ...
                    var dial_selectedCode = iti5.getSelectedCountryData().dialCode;

                    country_value4 = iti5.getSelectedCountryData().iso2;
                    $('#parent_phone_code').val(country_value4);
                    ...
                    $scope.formModel.discount_id = success.data.discount_id.split(",");
                    $('.yasir-ann-select2').val($scope.formModel.discount_id).trigger('change.select2');
                },
                function (error) {
                    //console.log(error.data)
                    $window.location.href = 'errors/' + error.status;
...
app2.controller("attendanceController", function ($scope, $http, $window, $location) {
   ...
   $scope.getSchoolAdmins = function(otherData){
      $http.post(base_url + 'syllabus/getSchoolAdmins', {}, config).then(
          function(success){
              publicNotificationViaPusher("lbl_approval_student_atttence", otherData,  success.data.new_ids, "applications/all",  'https:', ' ', {'sender': success.data.sender}, $scope.r_id);
          },
          function(error){
               console.log(error.data);
               //$window.location.href = 'errors/' + error.status;
            ...
            $http.post(base_url + 'timetable/save', $scope.yModel, config).then(
                    function (success) {
                        if (success.data.status === "success") {
                            ...
                            publicNotificationViaPusher(n.keyword, otherData, n.id, 'notification/index', 'https:', ' ', n.data);
                            $scope.yModel = {};
                        } else if (success.data.status === "error") {
                            showNotification(success.data.status, success.data.message, success.data.status);
                        }
...
app2.controller("duefeeController", function ($scope, $http, $window) {
    ...
    $scope.initAcademicYears =  function(){
        Loading("#filterAcademicYears", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'fee/getAcademicYears', "", config).then(
            function (success) {
                Loading("#filterAcademicYears", '<?php echo lang("loading_datatable") ?>', "", "hide");
                $scope.filterModel.academic_year_id = success.data.current_academic_year_id;
                $scope.initClasses($scope.filterModel.academic_year_id);
    ...
    $scope.filterBatches = function () {
        Loading("#dropdownBatches", '<?php echo lang("loading_datatable") ?>', "", "show");
            Loading("#dropdownBatches", '<?php echo lang("loading_datatable") ?>', "", "show");
            $http.post(base_url + 'fee/getClassBatches', $scope.filterModel, config).then(
                    function (success) {
                        Loading("#dropdownBatches", '<?php echo lang("loading_datatable") ?>', "", "hide");
                        $scope.batches = success.data;
...
app2.controller("feeCollectionController", function ($scope, $http, $window, $filter) {
    ...
    $scope.notesLength = 0;
    $scope.totalSum = {};
    $scope.exemptionModel = {
      exemption_amount : '',
      exemption_reason : '' 
    };
    $scope.discount_ids = {};

    //load discounts on the fee collection side added by sheraz
    $scope.loadDiscounts = function(){
        $http.post(base_url + 'fee/get_discounts', "", config).then(
        function (response) {
            $scope.discounts = response.data.discounts;
    ...
    $scope.selectedStd.fee_records = [];
    $scope.applyDiscounts = function(){
      $scope.selectedStd.discount_ids = $scope.discount_ids;
      $scope.selectedStd.fee_records = $scope.stdFeeRecords; 
      Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
      $http.post(base_url + 'fee/applyDiscounts', $scope.selectedStd, config).then(
        function (response) {
          Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                if(response.data.status == 'success'){
                ...
                if(response.data.status == 'error'){
                    $scope.fetchStudentFeeRecords($scope.selectedStd);
                    $(".yasir-ann-select2").val("").trigger('change.select2');
                    showNotification('<?php echo lang("error_app") ?>', response.data.message, response.data.status);
                }   
        });
    };
    ...
    $scope.getfeeStatusRecords = function () {
      $scope.fetchStudentFeeRecords($scope.selectedStd);
    }
    ...
    $scope.showDetails = function (std) {
        ...
        if($scope.selectedStd.discount_id != null && $scope.selectedStd.discount_id != 0){
          $scope.discount_ids = $scope.selectedStd.discount_id.split(",");
          $('.yasir-ann-select2').val($scope.discount_ids).trigger('change.select2');
        } else {
          $('.yasir-ann-select2').val("").trigger('change.select2');
        }
        $scope.fetchStudentFeeRecords($scope.selectedStd);
    ...
    $scope.fetchStudentFeeRecords = function (obj) {
        var formData = {
            ...
            scr_id: obj.student_class_relation_id, 
        ...
        $http.post(base_url + "fee/getStudentFeeRecrods", formData, config).then(
            function (success) {
                ...
                $scope.totalSum.exemption = 0;
                angular.forEach(success.data.records, function (value, key) {
                    if(value[0].fee_collection_id == 'NULL' && value[0].discounted_amount == 0 && (value[0].exemption_status == 'approved' || value[0].exemption_status == '') ){
                        $scope.setAddFeeCollectionModel(value[0]);
                        $scope.paid_amount = 0;
                        $scope.payfeeautomatically(true);
                    }
                    if(value[0].exemption_amount == ''){
                      value[0].exemption_amount = 0;
                    }
                    $scope.totalSum.exemption += parseFloat(value[0].exemption_amount);
                    $scope.totalSum.discounted += parseFloat(value[0].amount - value[0].discount);
                    $scope.totalSum.fee += parseFloat(value[0].amount);
                    if(value[0].feetype_status == 0){
    ...
    $scope.calculateBalance = function (obj){
        ...
        if(obj.length == 1){
            if(obj[0].fee_collection_id == 'NULL'){
              ...
              if(obj[0].exemption_status == 'not-approved'){
                balance =  obj[0].paid_amount - parseFloat(obj[0].feetype_amount - obj[0].discount);
              } else {
                balance =  obj[0].paid_amount - parseFloat(obj[0].feetype_amount - obj[0].discount - obj[0].exemption_amount);
              }
            }     
        } else {
            var paid_amount = 0;
            ...
            if(obj[0].exemption_status == 'not-approved'){
              ...
              balance = paid_amount - parseFloat(obj[0].feetype_amount - obj[0].discount - obj[0].exemption_amount);
            }
        }
        return balance;
    };
    ...
    $scope.isAllFeePaid = function(obj){
        ...
        angular.forEach(obj, function (value1, key) {
            total_paid_amount += parseInt(value1.paid_amount);
        });
        angular.forEach(obj, function (value, key) {
            if(value.status === "1" && value.exemption_status === 'not-approved'){
                if(value.feetype_amount == total_paid_amount){
                    is_all_paid = true;
                }
            }
            if(value.status === "1" && value.exemption_status !== 'not-approved'){
    ...
    $scope.isPartiallyPaid = function(obj){
    ...
    $scope.feeEditModel = {};
    $scope.feePartialEditModel = {};
    $scope.editFeeCollectionModel = function(obj){
        $scope.loading = false;
        $scope.feeEditModel = angular.copy(obj[0]);
        $scope.feeEditModel.paid_amount = parseInt($scope.feeEditModel.paid_amount);
        $scope.feeEditModel.created_at = $scope.today;
    }

    $scope.editPartiallyFeeCollectionModel = function(obj,allObj){
        $scope.maxEditPiadAmount = 0;
        $scope.feePartialEditModel = angular.copy(obj);
        $scope.feePartialEditModel.paid_amount = parseInt($scope.feePartialEditModel.paid_amount);
        $scope.feePartialEditModel.created_at = $scope.today;
        var total_paid_amount = 0;
        angular.forEach(allObj, function (value, key) {
            if(value.fee_collection_id != $scope.feePartialEditModel.fee_collection_id){
                total_paid_amount += parseFloat(value.paid_amount);
            }
        });

        if(obj.exemption_status == 'not-approved'){
          var discounted_amount = obj.feetype_amount - obj.discount;
        } else {
          var discounted_amount = obj.feetype_amount - obj.discount - obj.exemption_amount;
        }

        $scope.editPiadAmount = discounted_amount - total_paid_amount;
        $scope.maxEditPiadAmount = $scope.editPiadAmount;
        console.log($scope.feePartialEditModel);
    }
    ...
    $scope.setEditFeeCollectionModel = function (obj) {
        ...
        if(obj[0].exemption_status == 'not-approved'){
          ...
          var discounted_amount = obj[0].feetype_amount - obj[0].discount - obj[0].exemption_amount;
        }
    ...
    $scope.editPartailCollectFee = function(valid){
        if(valid){
            $http.post(base_url + "fee/editPartialCollectFee", {'obj': $scope.feePartialEditModel,'student_id':$scope.selectedStd.id}, config).then(
                function (success) {
                    $scope.fetchStudentFeeRecords($scope.selectedStd);
                    showNotification(success.data.status, success.data.message, success.data.status);
                    $('#partialEditFeeCollectionModel').modal('hide');
    ...
    $scope.editCollectFee = function(valid){
        if(valid){
            $http.post(base_url + "fee/editCollectFee", {'obj': $scope.feeEditModel}, config).then(
                function (success) {
                    $scope.fetchStudentFeeRecords($scope.selectedStd);
                    showNotification(success.data.status, success.data.message, success.data.status);
                    $('#editFeeCollectionModel').modal('hide');
                },
                function (error) {
                    $scope.loading = false;
                    console.log(error.data);
    ...
    $scope.getStudentGuardians = function(student_id, otherData){
        $http.post(base_url + 'syllabus/getStudentGuardians', {student_id:student_id}, config).then(
            function(success){
                publicNotificationViaPusher("lbl_fee_collection_notification", otherData, success.data.new_ids, "fee/collection", 'https://uvschools.com/restapis/api/get_feeRecord', student_id, {'sender': success.data.sender}, 0);
            },
            function(error){
                $window.location.href = 'errors/' + error.status;
            }
    ...
    $scope.collectFeeUpdate = function (valid) {
        ...
        if (valid) {
            ...
            $scope.editModel.discount_id = $scope.selectedStd.discount_id;
    ...
    $scope.showConfirmationAlert = function (obj, how_many) {
        if(obj.exemption_id == undefined){
            var exemption_id = obj[0].exemption_id;
            var request_log_id = obj[0].request_log_id;
        } else {
            var exemption_id = obj.exemption_id;
            var request_log_id = obj.request_log_id;
        }
        var ids = [];
        if(how_many === 'all'){
            angular.forEach(obj, function (value, key) {
        ...
        function (isConfirm) {
            if (isConfirm) {
            $http.post(base_url + "fee/sofeDeleteCollectedFee", {"ids": ids, 'type':how_many, 'exemption_id': exemption_id, 'request_log_id': request_log_id}, config).then(
                    function (success) {
                        if (success.data.status === "success") {
                            $("#myModalYasir").modal('hide');
    ...
    $scope.showConfirmationAlertRefund = function (obj, how_many) {
        //var exemption_id = obj[0].exemption_id;
        //var request_log_id = obj[0].request_log_id;
        if(obj.exemption_id == undefined){
            var exemption_id = obj[0].exemption_id;
        ...
        swal({
            ...
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55", confirmButtonText: '<?php echo lang("yes_refund") ?>',
            cancelButtonText: '<?php echo lang("btn_cancel") ?>',
            closeOnConfirm: true,
            closeOnCancel: true
        },
        function (isConfirm) {
            if (isConfirm) {
            $http.post(base_url + "fee/refundCollectedFee", {"ids": ids, 'type':how_many, 'exemption_id': exemption_id, 'request_log_id': request_log_id}, config).then(
                    function (success) {
                        if (success.data.status === "success") {
                            $("#myModalYasir").modal('hide');
                            $scope.showDetails($scope.selectedStd);
    ...
    $scope.setFeeValues = function (obj) {
      $scope.exemptionModel = angular.copy(obj[0]);
      
      if($scope.exemptionModel.fee_collection_id == "NULL") {
        $scope.exemptionModel.discounted_amount = obj[0].new_discounted_amount;
      }
      console.log();
      $scope.exemptionModel.student_id = $scope.selectedStd.id;
      $scope.exemptionModel.class_id = $scope.selectedStd.class_id;
      $scope.exemptionModel.batch_id = $scope.selectedStd.batch_id;

    };

    $scope.setExemption = function () {
      Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
      $http.post(base_url + 'fee/requestFeeExemption', $scope.exemptionModel, config).then(
      function (success){
        $scope.fetchStudentFeeRecords($scope.selectedStd);
        $('#exemptionModel').modal('hide');
        $('#exemptionModelNew').modal('hide');
        $scope.exemptionModel.exemption_reason = "";
        showNotification('Success', success.data.message, 'success');
        var otherData = "";
        publicNotificationViaPusher('new_exemption',otherData, success.data.part, 'fee/collection', {'sender': success.data.sender});
        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
      },
      function (error){
        console.log(error.data);
...
app2.controller('inbox', function ($scope, $http) {
    ...
    $scope.getSections_upload = function () {
        if($scope.sModel.class != null){
            $http.post(base_url + 'attendance/getClassBatches', {class_id: $scope.sModel.class}, config).then(
                function (response) {
    ...
    $scope.getStudentsForMsg = function (){
      Loading("#select2-students", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'messages/getStudentsForMessages', $scope.sModel, config).then(
            function (success) {
    ...
    $scope.resetCompose = function () {
        ...
        $('#student_selectall').attr('checked', false);
        $('#message_alert').hide();
        Dropzone.forElement("#my-awesome-dropzone").removeAllFiles(true);
    }
    ...
    $scope.dropzoneConfig = {
        'options': {// passed into the Dropzone constructor
            ...
            'maxFilesize': 20, //MB
            'maxFiles': 100,
            'acceptedFiles': "image/*, application/pdf, .doc, .docx, .ppt, .pptx, .xlsx",
            'addRemoveLinks': true,
            'dictRemoveFile': '<?php echo lang("lbl_remove");?>',
            'dictDefaultMessage': '<?php echo lang("drop_here");?>',
            'dictFileTooBig': 'File is bigger than 20MB',
...
app2.controller('uploadController', function ($scope, $http, $sce) {
    ...
    $scope.reset_assignmentMarkValue = function ()
    {
        $scope.Assignment_details.obtained_marks=null;
        $scope.Assignment_details.remarks=null;
    };
        

    $scope.reset_homeworkMarkValue = function ()
    {
        $scope.Homework_details.obtained_marks=null;
        $scope.Homework_details.remarks=null;
    };
    ...
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'study_material/newMaterial', $scope.study1).then(
                ...
                var otherData = {
                    ...
                    publicNotificationViaPusher('new_study_material',otherData, response.data.part, 'study_material/upload', 'https:', ' ', {'sender': response.data.sender});
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                });
    };
        ...
        $http.post(base_url + 'study_material/newAssignment', $scope.study3).then(
                function (response)
                {
                    if(response.data.uploaded=='true')
                    {
                        ...
                        showNotification('Success', response.data.message, 'success');
                        var otherData = {};
                        publicNotificationViaPusher('new_assignment',otherData, response.data.part, 'study_material/student_class_activities', 'https://uvschools.com/restapis/api/student_classactivity', ' ', {'sender': response.data.sender});
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    }
                    else
                    {
        ...
        $http.post(base_url + 'study_material/newAssignment', $scope.study4).then(
                function (response)
                {
                    if(response.data.uploaded=='true')
                    {
                        ...
                        showNotification('Success', response.data.message, 'success');
                        var otherData = {};
                        publicNotificationViaPusher('new_homework',otherData, response.data.part, 'study_material/student_class_activities', 'https://uvschools.com/restapis/api/student_classactivity', ' ', {'sender': response.data.sender});
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    }
                    else
                    {
    ...
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'study_material/newMaterial_general', $scope.study1).then(
                ...
                var otherData = {
                    ...
                    $('#upload').modal('toggle');
                    showNotification('Success', response.data.message, 'success');
                    publicNotificationViaPusher('new_study_material',otherData, response.data.part, 'study_material/upload', 'https://uvschools.com/restapis/api/student_studymaterial', ' ', {'sender': response.data.sender});
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    $scope.getMaterials();
                })
    }
  ...
  $scope.dropzoneConfigHomework = {
    ...
    $scope.materialEditDropzoneConfigUpload = {
        'options': {// passed into the Dropzone constructor
            ...
            'maxFiles': 100,
            'timeout': 0,
            'acceptedFiles': "image/*, application/pdf, .doc, .docx, .ppt, pptx, .mp4, .avi, .flv, .wmv, .mov, .webm, .mp3, .avi, .aac",
            'addRemoveLinks': true,
            'dictRemoveFile': '<?php echo lang("lbl_remove");?>',
            'dictDefaultMessage': '<?php echo lang("drop_here");?>',
            'dictFileTooBig': 'File is bigger than 1GB',
...
$scope.materialNewDropzoneConfigUpload = {
  ...
  $scope.showAssignmentDetail =  function(ass){
      ...
      $http.post(base_url + 'study_material/set_viewed_assignment_homework', {assignment_id: ass.submit_id}).then(
        function (response) {
            ...
            $scope.comments[i].comment_body = $sce.trustAsHtml($scope.comments[i].comment_body);
    ...
    $scope.Assignment_details = ass;
        ...
        $scope.Assignment_details.details = $sce.trustAsHtml($scope.Assignment_details.details);
        $scope.Assignment_details.submitted_details = $sce.trustAsHtml($scope.Assignment_details.submitted_details);
  ...
  $scope.showHomeworkDetail =  function(hom){
      ...
      $http.post(base_url + 'study_material/set_viewed_assignment_homework', {assignment_id: hom.submit_id}).then(
        function (response) {
            $scope.HomComments = response.data;

            for (var i = 0, len = $scope.HomComments.length; i < len; i++) {

            $scope.HomComments[i].comment_body = $sce.trustAsHtml($scope.HomComments[i].comment_body);
    ...
    $scope.Homework_details = hom;
        ...
        $scope.Homework_details.details = $sce.trustAsHtml($scope.Homework_details.details);
        $scope.Homework_details.submitted_details = $sce.trustAsHtml($scope.Homework_details.submitted_details);
...
app2.controller('profileController', function ($scope, $http, $sce) {
    ...
    $scope.show = function (id) {
        $http.post(base_url + "notification/show", {"id": id}, config).then(
                function (success) {
                    $scope.showNotification = success.data;
                    console.log(success.data);
    ...
    $scope.clickMe = function () {
        ...
        publicNotificationViaPusher(msg_key, recipient, url, 'https:', ' ', data);
    };
...
function publicNotificationViaPusher(msg_key, otherData, recipient, url, app_url='', app_id='', data, r_id) {
   $.ajax({
       url: base_url + "notification/sendNotificationViaPusher",
       method: "post",
       data: {msg_key: msg_key, recipient: recipient, url: url, app_url: app_url, app_id: app_id, data: data, r_id: r_id, other: otherData},
...
/*--- Image cropper ---*/
    ...
    $scope.onSubmit = function (valid, image, image1) {
        if (valid) {
            ...
            $scope.formModel.pPhone=final_countryPhone;
            $scope.formModel.u_phone_number=cntry_phone1;
            
            $scope.formModel.parent_phone_code=$("#country_change_code").val();
...
/*--- Image cropper ---*/
    ...
    $scope.resetPassword = function (){
        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'parents/resetPassword', {'parent_id': $scope.formModel.id}, config).then(
                function (success) {
                    if(success.data.status == 'success'){
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
    ...
    $scope.fetchParent = function (id) {
        $http.post(base_url + 'parents/getParent', {'parent_id': id}, config).then(
                function (success) {
                    ...
                    console.log($scope.formModel);
                    var u_phn_num=$scope.formModel.u_phone_number;
                    var complete_phone=$scope.formModel.contact;
                    
                    var country_value3="";
                    
                    document.getElementById('remove_parent_instance').textContent = '';
                    document.getElementById('remove_parent_instance').innerHTML = '<input class="form-control" style="width:100%;" type="text" name="phone" id="phone" ng-model="formModel.contact">';
                    globalval= success.data.parent_phone_code;
...
app2.controller("attendanceEmployeeCtrl", function ($scope, $http, $window, $location) {
    ...
    $scope.getSchoolAdmins = function(otherData){
      $http.post(base_url + 'syllabus/getSchoolAdmins', {}, config).then(
          function(success){
              publicNotificationViaPusher("lbl_approval_employee_atttence", otherData, success.data.new_ids, "applications/all", 'https:', ' ', {'sender': success.data.sender}, $scope.r_id);
          },
          function(error){
               $window.location.href = 'errors/' + error.status;
          }
        ...
        $('#myTablee').DataTable({
            ...
            columns: [
                ...
                */
                ...
                {title: '<?php echo lang("imp_parent_contact");?>', data: 'guardian_contact'},
...
app2.controller("marksheetController", function ($scope, $http, $window, $location) {
    ...
    $scope.academicyears = {};
    // auto calculator for total marks sheraz
    $scope.total = function(key){
        $scope.students_group_wise[key].total_activity = 0;
        angular.forEach($scope.students_group_wise[key].activities, function (value, key2) {
            if(value[key2] != undefined){
                $scope.students_group_wise[key].total_activity += value[key2].obtained_marks;
            }
        });
    }
    $scope.initAcademicYears =  function(){
   ...
   $scope.getSchoolAdmins = function(otherData){
      $http.post(base_url + 'syllabus/getSchoolAdmins', {}, config).then(
          function(success){
              publicNotificationViaPusher("lbl_approval_exam_marksheet", otherData,  success.data.new_ids, "applications/all", 'https:', ' ', {'sender': success.data.sender}, $scope.r_id);
          },
          function(error){
               $window.location.href = 'errors/' + error.status;
          }
                        ...
                        angular.forEach($scope.students, function (value, key) {
                            if(value.is_read == 'true'){
                                $scope.students_group_wise.push(value);
                                 // added new activities
                                $scope.activities.push(value.activities);
                                 // added new activities
                            }
                        });
        ...
        angular.forEach($scope.exams, function (value, key) {
            if(value.id == $scope.filterModel.exam_detail_id){
                ...
                $scope.printing_details.type = value.type;
                 // added new activities
                $scope.printing_details.total_activity_marks = value.totoal_activity_marks;
                $scope.printing_details.total_exam_marks = value.total_exam_marks;
                $scope.printing_details.activities = value.activities;
                 // added new activities
            }
        });
    ...
    $scope.saveMarksheet = function () {
        ...
        angular.forEach($scope.students_group_wise, function (value, key) {
            ...
            remarks = $("#remarks_"+key).val();
             // added new activities
            total_grade = $("#total_grade_"+key).val();
             // added new activities
            $scope.data.push({
                id: value.id, 
                ...
                passing_marks: $scope.passing_marks,
                 // added new activities
                exam_passing_marks: $scope.printing_details.exam_passing_marks,
                remarks: remarks,
...
app2.controller("syllabusController", function ($scope, $http, $window, $location, $filter) {
    ...
    $scope.getSchoolAdmins = function(otherData){
        $http.post(base_url + 'syllabus/getSchoolAdmins', {}, config).then(
            function(success){
                publicNotificationViaPusher("lbl_approval_syllabus", otherData, success.data.new_ids, "applications/all", 'https:', ' ', {'sender': success.data.sender}, $scope.r_id);
    ...
    $scope.getAllGuardians = function(otherData){
        $http.post(base_url + 'syllabus/getAllGuardians', otherData, config).then(
            function(success){
                publicNotificationViaPusher("lbl_study_plan_status_change_to_done", otherData, success.data.new_ids, "applications/all", 'https:', ' ', {'sender': success.data.sender}, $scope.r_id);
            },
            function(error){
                console.log(error.data);
            }
...
$scope.classes = {};
             ...
             Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
                ...
                $http.post(base_url + "notification/appNotification", {"reason":$scope.responseText, "notification_id": notification_id, "status":status, "id": req_id, "type":req_type, "date":req_date}, config).then(
                    function (success){
                        ...
                        var otherData = {};
                        publicNotificationViaPusher(success.data.message, otherData,  success.data.new_ids, "applications/all", 'https:', ' ', {'sender': success.data.sender}, req_id);
                        $scope.responseText = '';
    ...
    $scope.viewExemptions = function(feetype_id,school_id,student_id,academic_year_id){
      $scope.exmpModel.feetype_id = feetype_id;
      $scope.exmpModel.school_id = school_id;
      $scope.exmpModel.student_id = student_id;
      $scope.exmpModel.academic_year = academic_year_id;
      $http.post(base_url + 'fee/fetchExemption', $scope.exmpModel, config).then(
          function (success) {
            $scope.appViewModel = success.data[0];
          },
          function (error) {
...
app2.controller('bookshopCtrl', function ($scope, $http, $sce) {
    ...
    $scope.getAllBooksForStudents = function () {
        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'study_material/get_all_books_for_students', "", config).then(
                function (success) {
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    $scope.bookshop = $sce.trustAsHtml(success.data.bookshop);
                },
                function (error) {
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    $window.location.href = 'errors/' + error.status;
    ...
    $scope.getBookshopOfStudent =  function () {
        $http.post(base_url + 'study_material/get_books_of_student', $scope.arModel, config).then(
                function (success) {
                    $scope.bookshop = $sce.trustAsHtml(success.data.bookshop);
                },
                function (error) {
    ...
    $scope.getBookshopForStudent = function () {

        $http.post(base_url + 'study_material/get_bookshop_for_student', "", config).then(
        function (response) {
...
app2.controller("syllabusParentViewController", function ($scope, $http, $window, $location, $filter) {
    ...
    $scope.getSchoolAdmins = function(){
        $http.post(base_url + 'syllabus/getSchoolAdmins', {}, config).then(
            function(success){
                publicNotificationViaPusher("lbl_approval_syllabus",  success.data.new_ids, "applications/all", 'https:', ' ', {'sender': success.data.sender}, $scope.r_id);
                //$scope.adminIDs = success.data;
            },
            function(error){
                console.log(error.data);
...
app2.controller('downloadParentController', function ($window,$scope, $http, $sce) {
        ...
        $http.post(base_url + 'study_material/submitAssignment', $scope.study3, config).then(
                function (response)
                {
                    if(response.data.uploaded='true')
                    {
                        ...
                        showNotification('Success', response.data.message, 'success');
                        var otherData = {};
                        publicNotificationViaPusher('sub_homework',otherData, response.data.part, 'study_material/class_work', 'https:', ' ', {'sender': response.data.sender});
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                        $('.textarea_editor1').data("wysihtml5").editor.clear();
        ...
        $http.post(base_url + 'study_material/submitAssignment', $scope.study2, config).then(
                function (response)
                {
                    if(response.data.uploaded='true')
                    {
                        ...
                        showNotification('Success', response.data.message, 'success');
                        var otherData = {};
                        publicNotificationViaPusher('sub_assignment',otherData, response.data.part, 'study_material/class_work', 'https:', ' ', {'sender': response.data.sender});
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                        $('.textarea_editor').data("wysihtml5").editor.clear();
   ...
   $scope.init = function () {
    ...
    $scope.initClasswork = function () {
       
        Loading("#syllabusFilterChilds", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'study_material/getChilds', "", config).then(
                function (success) {
                    $scope.parentchild = success.data.student_ids;
                    $scope.study.materials = success.data.materials;
                    Loading("#syllabusFilterChilds", '<?php echo lang("loading_datatable") ?>', "", "hide");
...
$scope.initSubjects = function (student_id) {
    ...
    $scope.filterClassWork = function () {
        $scope.class_error = false;
        $scope.subject_error = false;
        $scope.type_error = false;
        $check = true;
     ...
     if ($check) {
            ...
            $http.post(base_url + 'study_material/filter_class_work_parent', {type:$scope.type,student_id:$scope.student_id,subject_id:$scope.subject_id}).then(
            function (response) {
                $scope.study.materials = response.data.materials;
                for (var i = 0, len = $scope.study.materials.length; i < len; i++) {
                    $scope.study.materials[i]['details'] = $sce.trustAsHtml($scope.study.materials[i]['details']);
     ...
     if ($check) {
            ...
            function (response) {
                ...
                for (var i = 0, len = $scope.study.materials1.length; i < len; i++) {
                    $scope.study.materials1[i]['details'] = $sce.trustAsHtml($scope.study.materials1[i]['details']);
                   // updates at testing
                   //$scope.study.materials1[i]['submitted_details'] = $sce.trustAsHtml($scope.study.materials1[i]['submitted_details']);
                }
    ...
    {
        Loading("body", "<?php echo lang("loading_datatable") ?>", "", "show");
            $http.post(base_url + 'study_material/set_viewed_assignment_homework', {assignment_id: matd.submit_material_id}).then(
                function (response)
                {
                    $scope.comments = response.data;
                    for (var i = 0, len = $scope.comments.length; i < len; i++)
        ...
        $scope.details.submitted_file_names = matd.submitted_file_names;
        $scope.details.submitted_files = matd.submitted_files;
        $scope.details.submitted_filesurl = matd.submitted_filesurl;
        $scope.details.submitted_thumbnail_links = matd.submitted_thumbnail_links;
        // google drive
        ...
        $scope.details.submitted_files = matd.submitted_files;
        $scope.details.remarks = matd.remarks;
        $scope.details.student_avatar = matd.student_avatar;
        $scope.details.status = matd.status;
        $scope.details.student_name = matd.student_name;
        $scope.details.submit_material_id = matd.submit_material_id;
        $scope.details.submitted_details = $sce.trustAsHtml(matd.submitted_details);
    };

    $scope.details_set2 = function (matr)
    {
        Loading("body", "<?php echo lang("loading_datatable") ?>", "", "show");
        $http.post(base_url + 'study_material/set_viewed_assignment_homework', {assignment_id: matr.submit_material_id}).then(
          function (response) {
              $scope.HomComments = response.data;
        ...
        $scope.details.submitted_file_names = matr.submitted_file_names;
        $scope.details.submitted_files = matr.submitted_files;
        $scope.details.submitted_filesurl = matr.submitted_filesurl;
        $scope.details.submitted_thumbnail_links = matr.submitted_thumbnail_links;
        // google drive
        ...
        $scope.details.teacher_id = matr.teacher_id;
        $scope.details.teacher_name = matr.teacher_name;
        //$scope.details.submitted_details = matr.submitted_details;
        $scope.details.submitted_files = matr.submitted_files;
        $scope.details.remarks = matr.remarks;
        $scope.details.student_avatar = matr.student_avatar;
        $scope.details.status = matr.status;
        $scope.details.student_name = matr.student_name;
        $scope.details.submit_material_id = matr.submit_material_id;
        $scope.details.submitted_details = $sce.trustAsHtml(matr.submitted_details);
    };
...
app2.controller("payrollController", function ($scope, $http, $window, $filter) {
    ...
    //all academic year fumctions added by sheraz #AYP
    $scope.initAcademicYears =  function(){
        Loading("#filterAcademicYears", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'fee/getAcademicYears', "", config).then(
            function (success) {
    ...
    $scope.initSalaryGroups = function(){
        $http.post(base_url + 'payroll/fetchPayrollGroupsOfSchool', $scope.academic_year_id, config).then(
            function (success) {
    ...
    $scope.fetchEmployeePayrollRecords = function (obj) {
        $scope.academic_year_id = $scope.filterModel.academic_year_id;
        var formData = {
            emp_id: obj.id, 
            department_id: obj.department_id, 
            category_id: obj.category_id,
            basic_salary: obj.basic_salary,
            academic_year_id: $scope.filterModel.academic_year_id
        };
    ...
    $scope.collectPayroll = function (valid) {
        if (valid) {
            $("#payRollPayBtn").addClass("custom_disable");
            $scope.afcModel.paid_amount = $scope.paid_amount;
            ...
            //#AYP added by sheraz
            $scope.afcModel.academic_year_id = $scope.filterModel.academic_year_id;
            $http.post(base_url + "payroll/collect", $scope.afcModel, config).then(
                function (success) {
                     if (success.data.status === "success") {
                        $("#payRollPayBtn").removeClass("custom_disable");
                        $scope.loading = false;
    ...
    $scope.collectPayrollUpdate = function (valid) {
        ...
        $scope.uModel.academic_year_id = $scope.filterModel.academic_year_id;
...
app2.controller("accountController", function ($scope, $http,) {
    ...
    $scope.setFeeId = function (id){
        $scope.deleteFeeId = id;
    };

    $scope.deleteCollectedFee = function(){
        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'accounts/deleteCollectedFeePermanently', {id : $scope.deleteFeeId}, config).then(
                function (success) {
                $('#feeDeleteModal').modal('hide');
                $scope.getAllData();
                Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
            });
    };

    $scope.getFeeDetails = function(id){

        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'accounts/getNewFeeDetails', {id : id}, config).then(
                function (success) {
                Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                $scope.nfModel = success.data;
            });
    ...
    $scope.initAcademicYears =  function(){
        ...
        $http.post(base_url + 'fee/getAcademicYearsParentFee', "", config).then(
            function (success) {
                Loading("#feeFilterAcademicYears", '<?php echo lang("loading_datatable") ?>', "", "hide");
                $scope.fcModel.academic_year_id = success.data.current_academic_year_id;
                $scope.currentAcademicYear = success.data.current_academic_year_id;
                $scope.academicyears = success.data.data;
            },
            function (error) {
                Loading("#feeFilterAcademicYears", '<?php echo lang("loading_datatable") ?>', "", "hide");
    ...
    $scope.fetchAcademicYearData = function(){
      Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'accounts/getAllData', {academic_year_id : $scope.fcModel.academic_year_id}, config).then(
                function (success) {
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    ...
                    $scope.total_balance = success.data.total_balance;
                    $scope.school_currency = success.data.school_currency;
                    $scope.total_income_cash = success.data.total_income_cash;
                    $scope.total_income_cheque = success.data.total_income_cheque;
                    $scope.total_income_dd = success.data.total_income_dd;
                    $scope.total_fee_cash = success.data.total_fee_cash;
                    $scope.total_fee_cheque = success.data.total_fee_cheque;
                    $scope.total_fee_dd = success.data.total_fee_dd;
                    $scope.total_deduction_cash = success.data.total_deduction_cash;
                    $scope.total_other_income_cash = success.data.total_other_income_cash;
                    $scope.total_other_income_cheque = success.data.total_other_income_cheque;
                    $scope.total_other_income_dd = success.data.total_other_income_dd;
                    $scope.total_expense_cash = success.data.total_expense_cash;
                    $scope.total_expense_cheque = success.data.total_expense_cheque;
                    $scope.total_expense_dd = success.data.total_expense_dd;
                    $scope.total_payroll_cash = success.data.total_payroll_cash;
                    $scope.total_payroll_cheque = success.data.total_payroll_cheque;
                    $scope.total_payroll_dd = success.data.total_payroll_dd;
                    $scope.total_all_exp_cash = success.data.total_all_exp_cash;
                    $scope.total_all_exp_cheque = success.data.total_all_exp_cheque;
                    $scope.total_all_exp_dd = success.data.total_all_exp_dd;
                    $scope.total_balance_cash = success.data.total_balance_cash;
                    $scope.total_balance_cheque = success.data.total_balance_cheque;
                    $scope.total_balance_dd = success.data.total_balance_dd;
    ...
    $scope.get_incomes_expenses = function(){
        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
        $http.post(base_url + 'accounts/get_incomes_expenses', {academic_year_id : $scope.fcModel.academic_year_id}, config).then(
                function (success) {
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    $scope.incomes = success.data.incomes;
                    $scope.expenses = success.data.expenses;
                    ...
                    $scope.total_other_income_cheque = success.data.total_other_income_cheque;
                    $scope.total_other_income_dd = success.data.total_other_income_dd;
                    $scope.total_other_expense_cash = success.data.total_other_expense_cash;
                    $scope.total_other_expense_cheque = success.data.total_other_expense_cheque;
                    $scope.total_other_expense_dd = success.data.total_other_expense_dd;
                    $scope.total_payroll_cash = success.data.total_payroll_cash;
                    $scope.total_payroll_cheque = success.data.total_payroll_cheque;
                    $scope.total_payroll_dd = success.data.total_payroll_dd;
                    $scope.total_all_exp_cash = success.data.total_all_exp_cash;
        ...
        'options': {// passed into the Dropzone constructor
            ...
            init: function () {
                ...
                submitButton.addEventListener("click", function () {
                    ...
                    if ($scope.currentAcademicYear == $scope.fcModel.academic_year_id) {
                        $scope.newIncome();
                    } else {
                        $('#incomeAlert').modal('show');
    ...
    $scope.income.academic_year_id = $scope.fcModel.academic_year_id;
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    ...
    $scope.updateIncome = function () {
        $scope.eidtIncome.academic_year_id = $scope.fcModel.academic_year_id;
        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    ...
    $scope.expense.academic_year_id = $scope.fcModel.academic_year_id;
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    ...
    $scope.editExpense.academic_year_id = $scope.fcModel.academic_year_id;
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
...
app2.controller("onlineAdmissionCtrl", function ($scope, $http, $window, FileUploader) {
    ...
    $scope.details = function(){
        ...
        var cntry_phone3_code = $("#remove_phone3_instance .iti__selected-dial-code").text();
        var cntry_phone3 = $("#phone3").val();
        var final_countryPhone3 = cntry_phone3_code+cntry_phone3;
        
                
        var cntry_phone2_code = $("#remove_phone2_instance .iti__selected-dial-code").text();
        var cntry_phone2 = $("#phone2").val();
        var final_countryPhone2 = cntry_phone2_code+cntry_phone2;
        
                
        var cntry_phone1_code = $("#remove_instance .iti__selected-dial-code").text();
        var cntry_phone1 = $("#phone").val();
        var final_countryPhone1 = cntry_phone1_code+cntry_phone1;
        
        
        formData.child_phone_code=$('#country_change_code1').val();
        formData.parent_phone_code=$('#country_change_code2').val();
        formData.s_g_phone_code=$('#country_change_code3').val();
        
        
        formData.parent_phone_no=final_countryPhone2;
        formData.parent_phone_only=cntry_phone2;
        
        formData.s_g_phone_no=final_countryPhone3;
        formData.s_g_phone_only=cntry_phone3;
        
        formData.child_phone_no=final_countryPhone1;
        formData.child_phone_only=cntry_phone1;
    ...
    $scope.edit_application = function(id){
        ...
        $http.post(base_url + 'online_admission/get_application', {'id': id}, config).then(
            function(success){
                ...
                //for parent phone number
                var country_value1="";
                document.getElementById('remove_instance').textContent = '';
                document.getElementById('remove_instance').innerHTML = '<input class="form-control" style="width:100%;" type="text" id="phone1" ng-model="updateModel.parent_phone_no" >';
                
                var us_country=success.data.parent_phone_code
                
                globalval= us_country;
                var pinput = document.querySelector("#phone1");
                var piti = window.intlTelInput(pinput, {
                initialCountry: globalval,
                separateDialCode:true,
                utilsScript: "https://cdn.jsdelivr.net/npm/intl-tel-input@17.0.3/build/js/utils.js",
                });
                ...
                $("#phone1").val(success.data.u_phone_number);
                pinput.addEventListener('countrychange', function(e) {
                    country_value1 = piti.getSelectedCountryData().iso2;
                    $('#parent_phone_code').val(country_value1);
                });
                
                
                //For second guardian phone number
                var country_value2="";
                document.getElementById('remove_instance1').textContent = '';
                document.getElementById('remove_instance1').innerHTML = '<input class="form-control" style="width:100%;" type="text" id="phone2" ng-model="updateModel.second_parent_phone_no" >';
                
                var us_country_sp=success.data.s_g_phone_code
                
                globalval= us_country_sp;
                var sg_input = document.querySelector("#phone2");
                var sg_iti = window.intlTelInput(sg_input, {
                initialCountry: globalval,
                separateDialCode:true,
                utilsScript: "https://cdn.jsdelivr.net/npm/intl-tel-input@17.0.3/build/js/utils.js",
                });
                ...
                $("#phone2").val(success.data.second_phone_number);
                sg_input.addEventListener('countrychange', function(e) {
                    country_value2 = sg_iti.getSelectedCountryData().iso2;
                    $('#s_g_phone_code').val(country_value2);
                });
                
                                
                
                //For child phone number
                var country_value3="";
                document.getElementById('remove_instance2').textContent = '';
                document.getElementById('remove_instance2').innerHTML = '<input class="form-control" style="width:100%;" type="text" id="phone3" ng-model="updateModel.std_phone_no" >';
                
                
                var us_country_ch=success.data.child_phone_code
                
                globalval= us_country_ch;
                var ch_input = document.querySelector("#phone3");
                var ch_iti = window.intlTelInput(ch_input, {
                initialCountry: globalval,
                separateDialCode:true,
                utilsScript: "https://cdn.jsdelivr.net/npm/intl-tel-input@17.0.3/build/js/utils.js",
                });
                ...
                $("#phone3").val(success.data.std_phone_number);
                ch_input.addEventListener('countrychange', function(e) {
                    country_value3 = ch_iti.getSelectedCountryData().iso2;
                    $('#child_phone_code').val(country_value3);
                });
    ...
    $scope.update_application = function(){
        ...
        //child 
        var cntry_phone3_code = $("#remove_instance2 .iti__selected-dial-code").text();
        var cntry_phone3 = $("#phone3").val();
        var final_countryPhone3 = cntry_phone3_code+cntry_phone3;
        
        //sec parent  
        var cntry_phone2_code = $("#remove_instance1 .iti__selected-dial-code").text();
        var cntry_phone2 = $("#phone2").val();
        var final_countryPhone2 = cntry_phone2_code+cntry_phone2;
        
        //parent    
        var cntry_phone1_code = $("#remove_instance .iti__selected-dial-code").text();
        var cntry_phone1 = $("#phone1").val();
        var final_countryPhone1 = cntry_phone1_code+cntry_phone1;
        
        
        $scope.updateModel.child_phone_code=$('#child_phone_code').val();
        $scope.updateModel.parent_phone_code=$('#parent_phone_code').val();
        $scope.updateModel.s_g_phone_code=$('#s_g_phone_code').val();
        
        
        $scope.updateModel.parent_phone_no=final_countryPhone1;
        $scope.updateModel.u_phone_number=cntry_phone1;
        
        $scope.updateModel.second_parent_phone_no=final_countryPhone2;
        $scope.updateModel.second_phone_number=cntry_phone2;
        
        $scope.updateModel.std_phone_no=final_countryPhone3;
        $scope.updateModel.std_phone_number=cntry_phone3;
...
app2.controller("onlineClassesCtrl", function ($scope, $http, $window, $location) {
   ...
   $scope.newAppCheckClasses = function () {
            var el = document.getElementsByTagName("iframe")[0];
            if(el != undefined){
                 el.parentNode.removeChild(el);
            }
            Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
            $http.post(base_url + 'online_app/newAppCheckClasses', '', config).then(
                   function (success) {
                   console.log(success.data);
                       Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                       //$scope.classData = success.data;
    ...
    $scope.newAppOnlineClassRefresh = function(){
        $window.location.reload();
    }
...
app2.controller("announcementsCtrl", function ($scope, $http, FileUploader, $sce) {
        ...
        $http.post(base_url + 'announcements/save', $scope.sModel, config).then(
            function (success) {
                ...
                if(success.data.status == "success"){
                    ...
                    $scope.classes = [];
                    $scope.batches = [];
                    $('.textarea_editor_announcement').data("wysihtml5").editor.clear();
                    $scope.initClasses();
                    $scope.initDepartments();
                    publicNotificationViaPusher("new_announcement", otherData,  success.data.recipants, 'announcements/details/'+success.data.new_announcement_id, 'https://uvschools.com/restapis/api/get_announcements', ' ', {'sender': success.data.sender}, 0);
                }
            },
            function (error) {
                Loading("#ann-add-modal-contents", '<?php echo lang("loading_datatable") ?>', "", "hide");
    ...
    $scope.initEmployees = function(){
        ...
        $http.post(base_url + 'announcements/getDepCatEmployees', {categories: $scope.sModel.categories, departments: $scope.sModel.departments}, config).then(
            function (success) {
    ...
    $scope.initEditEmployees = function(){
        ...
        $http.post(base_url + 'announcements/getDepCatEmployees', {categories: $scope.eModel.categories, departments: $scope.eModel.departments}, config).then(
            function (success) {
                $scope.employees = success.data.employees;
...
app2.controller("onlineExamsController", function ($scope, $http, $interval, $window) {
    ...
    $scope.getSchoolAdmins = function(otherData){
        $http.post(base_url + 'syllabus/getSchoolAdmins', {}, config).then(
        function(success){
        publicNotificationViaPusher("lbl_online_exam_edit_approval", otherData,  success.data.new_ids, "applications/all", 'https:', ' ', {'sender': success.data.sender}, $scope.r_id);
        },
        function(error){
            console.log(error.data);
            //$window.location.href = 'errors/' + error.status;
...
app2.controller('commentsController', function ($scope, $http, $sce) {

    $scope.study5 = {};
    $scope.study6 = {};
    $scope.study7 = {};
    $scope.study8 = {};
    $scope.study5.submit_mat_id = {};
    $scope.study6.submit_mat_id = {};
    $scope.study7.submit_mat_id = {};
    $scope.study8.submit_mat_id = {};
    $scope.study5.files = [];
    $scope.study6.files = [];
    $scope.study7.files = [];
    $scope.study8.files = [];

    //Teacher side assignment comments dropzone
    $scope.DropzoneConfigMessage = {
        'options': {// passed into the Dropzone constructor
            'url': base_url + 'study_material/upload_attachments',
            'autoProcessQueue': true,
            'autoDiscover': false,
            ...
            'dictFileTooBig': 'File is bigger than 1GB',
            init: function () {
                var submitButton = document.querySelector("#send_message");
                myDropzone = this;
                submitButton.addEventListener("click", function (event) {
                    $scope.study5.submit_mat_id=event.target.name;
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
                    var text = $('.textarea_editor').val();
                    $scope.study5.text = text;
                    if ($scope.study5.files.length == 0 && ($scope.study5.text == undefined || $scope.study5.text == "")){
                        $('#message_alert').removeClass('alert-success').addClass('alert-danger').html('<?php echo lang("write_details"); ?>').show();
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    }
                    else if ($scope.study5.files.length == 0 && $scope.study5.text != undefined && $scope.study5.text != ""){
                        $scope.SendNewComment();
                    }
                    else if ($scope.study5.files.length != 0){
                        $scope.SendNewComment();
                    }
                ...
                myDropzone.on("removedfile", function (file) {
                    $scope.study5.files = $scope.study5.files.filter(function( obj ) {
                        return obj.name !== file.name;
                    });
                });
            }
        ...
        'eventHandlers': {
            ...
            'success': function (file, response) {
                $scope.study5.files = $scope.study5.files.concat(JSON.parse(response));
                $scope.$apply();
            }
        }
    };

    $scope.DropzoneConfigMessageView = {
        'options': {// passed into the Dropzone constructor
            'url': base_url + 'study_material/upload_attachments',
            'autoProcessQueue': true,
            'autoDiscover': false,
            ...
            'dictFileTooBig': 'File is bigger than 1GB',
            init: function () {
                var submitButton = document.querySelector("#send_message_view");
                myDropzone = this;
                submitButton.addEventListener("click", function (event) {
                    $scope.study5.submit_mat_id=event.target.name;
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
                    ...
                    $scope.study5.text = text;
                    if ($scope.study5.files.length == 0 && ($scope.study5.text == undefined || $scope.study5.text == "")){
                        $('#message_alert_view').removeClass('alert-success').addClass('alert-danger').html('<?php echo lang("write_details"); ?>').show();
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    }
                    else if ($scope.study5.files.length == 0 && $scope.study5.text != undefined && $scope.study5.text != ""){
                        $scope.SendNewCommentView();
                    }
                    else if ($scope.study5.files.length != 0){
                        $scope.SendNewCommentView();
                    }
    ...
    //Teacher side homework comments dropzone
    $scope.DropzoneConfigMessageHom = {
        'options': {// passed into the Dropzone constructor
            'url': base_url + 'study_material/upload_attachments',
            'autoProcessQueue': true,
            'autoDiscover': false,
            ...
            'dictFileTooBig': 'File is bigger than 1GB',
            init: function () {
                var submitButton = document.querySelector("#send_message_hom");
                myDropzone = this;
                submitButton.addEventListener("click", function (event) {
                    $scope.study6.submit_mat_id=event.target.name;
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
                    var text = $('.textarea_editor1').val();
                    $scope.study6.text = text;
                    if ($scope.study6.files.length == 0 && ($scope.study6.text == undefined || $scope.study6.text == "")){
                        $('#message_alert').removeClass('alert-success').addClass('alert-danger').html('<?php echo lang("write_details"); ?>').show();
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    }
                    else if ($scope.study6.files.length == 0 && $scope.study6.text != undefined && $scope.study6.text != ""){
                        $scope.SendNewCommentHom();
                    }
                    else if ($scope.study6.files.length != 0){
                        $scope.SendNewCommentHom();
                    }
                ...
                myDropzone.on("removedfile", function (file) {
                    $scope.study6.files = $scope.study6.files.filter(function( obj ) {
                        return obj.name !== file.name;
                    });
                });
            }
        ...
        'eventHandlers': {
            ...
            'success': function (file, response) {
                $scope.study6.files = $scope.study6.files.concat(JSON.parse(response));
                $scope.$apply();
            }
        }
    };

    $scope.DropzoneConfigMessageHomView = {
        'options': {// passed into the Dropzone constructor
            'url': base_url + 'study_material/upload_attachments',
            'autoProcessQueue': true,
            'autoDiscover': false,
            ...
            'dictFileTooBig': 'File is bigger than 1GB',
            init: function () {
                var submitButton = document.querySelector("#send_message_hom_view");
                myDropzone = this;
                submitButton.addEventListener("click", function (event) {
                    $scope.study6.submit_mat_id=event.target.name;
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
                    ...
                    $scope.study6.text = text;
                    if ($scope.study6.files.length == 0 && ($scope.study6.text == undefined || $scope.study6.text == "")){
                        $('#message_alert_hom_view').removeClass('alert-success').addClass('alert-danger').html('<?php echo lang("write_details"); ?>').show();
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    }
                    else if ($scope.study6.files.length == 0 && $scope.study6.text != undefined && $scope.study6.text != ""){
                        $scope.SendNewCommentHomView();
                    }
                    else if ($scope.study6.files.length != 0){
                        $scope.SendNewCommentHomView();
                    }
    ...
    //student side assignment comments dropzone
    $scope.DropzoneConfigMessageStd = {
        'options': {// passed into the Dropzone constructor
            'url': base_url + 'study_material/upload_attachments',
            'autoProcessQueue': true,
            'autoDiscover': false,
            ...
            'dictFileTooBig': 'File is bigger than 1GB',
            init: function () {
                var submitButton = document.querySelector("#send_message_std");
                myDropzone = this;
                submitButton.addEventListener("click", function (event) {
                    $scope.study7.submit_mat_id = event.target.name;
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
                    var text = $('.textarea_editor2').val();
                    $scope.study7.text = text;
                    if ($scope.study7.files.length == 0 && ($scope.study7.text == undefined || $scope.study7.text == "")){
                        $('#message_alert_std').removeClass('alert-success').addClass('alert-danger').html('<?php echo lang("write_details"); ?>').show();
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    }
                    else if ($scope.study7.files.length == 0 && $scope.study7.text != undefined && $scope.study7.text != ""){
                        $scope.SendNewCommentStd();
                    }
                    else if ($scope.study7.files.length != 0){
                        $scope.SendNewCommentStd();
                    }
    ...
    //student side homework comments dropzone
    $scope.DropzoneConfigMessageStdHom = {
        'options': {// passed into the Dropzone constructor
            'url': base_url + 'study_material/upload_attachments',
            'autoProcessQueue': true,
            'autoDiscover': false,
            ...
            'dictFileTooBig': 'File is bigger than 1GB',
            init: function () {
                var submitButton = document.querySelector("#send_message_std_hom");
                myDropzone = this;
                submitButton.addEventListener("click", function (event) {
                    $scope.study8.submit_mat_id = event.target.name;
                    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
                    var text = $('.textarea_editor3').val();
                    $scope.study8.text = text;
                    if ($scope.study8.files.length == 0 && ($scope.study8.text == undefined || $scope.study8.text == "")){
                        $('#message_alert_std_hom').removeClass('alert-success').addClass('alert-danger').html('<?php echo lang("write_details"); ?>').show();
                        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
                    }
                    else if ($scope.study8.files.length == 0 && $scope.study8.text != undefined && $scope.study8.text != ""){
                        $scope.SendNewCommentStdHom();
                    }
                    else if ($scope.study8.files.length != 0){
                        $scope.SendNewCommentStdHom();
                    }
    ...
    $scope.SendNewCommentStdHom = function(){
      $http.post(base_url + 'comments/SendNewCommentStd', $scope.study8).then(
                function (response) {
                      $('#openHomeworkView').modal('toggle');
                      showNotification('Success', response.data.message, 'success');
                      var otherData = {};
                      publicNotificationViaPusher('comments',otherData, response.data.part, 'study_material/class_work', 'https:', ' ', {'sender': response.data.sender});
                      $('.textarea_editor3').data("wysihtml5").editor.clear();
                      $('#message_alert_std_hom').hide();
                      Dropzone.forElement("#my-awesome-dropzone_messages_std_hom").removeAllFiles(true);
                      Loading("body", "<?php echo lang("loading_datatable") ?>", "", "hide");
                });
  };

    $scope.SendNewCommentStd = function(){
      $http.post(base_url + 'comments/SendNewCommentStd', $scope.study7).then(
                function (response) {
                      $('#openAssignmentView').modal('toggle');
                      showNotification('Success', response.data.message, 'success');
                      var otherData = {};
                      publicNotificationViaPusher('comments',otherData, response.data.part, 'study_material/class_work', 'https:', ' ', {'sender': response.data.sender});
                      $('.textarea_editor2').data("wysihtml5").editor.clear();
                      $('#message_alert_std').hide();
                      Dropzone.forElement("#my-awesome-dropzone_messages_std").removeAllFiles(true);
                      Loading("body", "<?php echo lang("loading_datatable") ?>", "", "hide");
                });
  };

    $scope.SendNewComment = function(){
        $http.post(base_url + 'comments/SendNewComment', $scope.study5).then(
                function (response) {
                      $('#markAssignment').modal('toggle');
                      showNotification('Success', response.data.message, 'success');
                      var otherData = {};
                      publicNotificationViaPusher('comments',otherData, response.data.part, 'study_material/student_class_activities', 'https://uvschools.com/restapis/api/student_classactivity', ' ', {'sender': response.data.sender});
                      $('.textarea_editor').data("wysihtml5").editor.clear();
                      $('#message_alert').hide();
                      Dropzone.forElement("#my-awesome-dropzone_message").removeAllFiles(true);
                      Loading("body", "<?php echo lang("loading_datatable") ?>", "", "hide");
                });
  };

  $scope.SendNewCommentHom = function(){
      $http.post(base_url + 'comments/SendNewComment', $scope.study6).then(
              function (response) {
                    $('#markHomework').modal('toggle');
                    showNotification('Success', response.data.message, 'success');
                    var otherData = {};
                    publicNotificationViaPusher('comments',otherData, response.data.part, 'study_material/student_class_activities', 'https://uvschools.com/restapis/api/student_classactivity', ' ', {'sender': response.data.sender});
                    $('.textarea_editor1').data("wysihtml5").editor.clear();
                    $('#message_alert_hom').hide();
                    Dropzone.forElement("#my-awesome-dropzone_message_hom").removeAllFiles(true);
                    Loading("body", "<?php echo lang("loading_datatable") ?>", "", "hide");
              });
  };

  $scope.SendNewCommentHomView = function(){
      $http.post(base_url + 'comments/SendNewComment', $scope.study6).then(
              function (response) {
                    $('#markHomeworkView').modal('toggle');
                    showNotification('Success', response.data.message, 'success');
                    var otherData = {};
                    publicNotificationViaPusher('comments',otherData, response.data.part, 'study_material/student_class_activities', 'https://uvschools.com/restapis/api/student_classactivity', ' ', {'sender': response.data.sender});
                    $('.textarea_editor3').data("wysihtml5").editor.clear();
                    $('#message_alert_hom_view').hide();
                    Dropzone.forElement("#my-awesome-dropzone_message_hom_view").removeAllFiles(true);
                    Loading("body", "<?php echo lang("loading_datatable") ?>", "", "hide");
              });
  };

  $scope.SendNewCommentView = function(){
    $http.post(base_url + 'comments/SendNewComment', $scope.study5).then(
              function (response) {
                    $('#markAssignmentView').modal('toggle');
                    showNotification('Success', response.data.message, 'success');
                    var otherData = {};
                    publicNotificationViaPusher('comments',otherData, response.data.part, 'study_material/student_class_activities', 'https://uvschools.com/restapis/api/student_classactivity', ' ', {'sender': response.data.sender});
                    $('.textarea_editor2').data("wysihtml5").editor.clear();
                    $('#message_alert_view').hide();
                    Dropzone.forElement("#my-awesome-dropzone_message_view").removeAllFiles(true);
                    Loading("body", "<?php echo lang("loading_datatable") ?>", "", "hide");
              });
};

});
// new controller activities sheraz
app2.controller("examActivities", function ($scope, $http , $window, $compile) {
  ...
  $scope.getSections_upload = function () {
  Loading("#section_search_filter", '<?php echo lang("loading_datatable") ?>', "", "show");
        $scope.class_error = false;
        $http.post(base_url + 'attendance/getClassBatches', {class_id: $scope.study.class}, config).then(
                function (response) {
                    $scope.study.batches = response.data;
                    Loading("#section_search_filter", '<?php echo lang("loading_datatable") ?>', "", "hide");
                });
    };

  $scope.getSections = function () {
        $http.post(base_url + 'attendance/getClassBatches', {class_id: $scope.exam_details.class}, config).then(
                function (response) {
                    $scope.sections = response.data;
                });
    };

    $scope.getSectionsEdit = function () {
        $http.post(base_url + 'attendance/getClassBatches', {class_id: $scope.exam_details1.class}, config).then(
                function (response) {
                    $scope.sections1 = response.data;
                    $scope.getSubjectsEdit();
                });
    };

    $scope.getSubjects = function (){
    $http.post(base_url + 'examination/getSubjects', {class_id: $scope.exam_details.class, batch_id: $scope.exam_details.section}, config).then(
    function (response) {
                    $scope.subjects = response.data;
                });
  };

    $scope.getSubjectsEdit = function (){
    $http.post(base_url + 'examination/getSubjects', {class_id: $scope.exam_details1.class, batch_id: $scope.exam_details1.section}, config).then(
    function (response) {
                    $scope.subjects1 = response.data;
                    $scope.getActivitiesEdit();
                });
    };
    ...
    $scope.add_exam = function (){
      ...
      $("#add_exam").show();
      $("#errorMessage").hide();
      //changes added by sheraz
      $http.post(base_url + 'examination/getSchoolExamsForActiveYear', "", config).then(
                function (response) {
                    $scope.exams = response.data;
                    //set the default start and end time added by sheraz
                    $scope.exam_details.start_time='9:00 am';
                    $scope.exam_details.end_time='10:00 pm';
                });
    };

  $scope.getActivities = function (){
    $http.post(base_url + 'examination/getActivities', $scope.exam_details, config).then(
        function (response) {
              ...
              $scope.activities = angular.copy(response.data);

              angular.forEach($scope.activities, function (value, key) {
               
              $scope.activities[key].marks = '';
  ...
  $scope.getActivitiesEdit = function (){
    $http.post(base_url + 'examination/getActivitiesEdit', $scope.exam_details1, config).then(
        function (response) {

              $scope.activities1 = angular.copy(response.data);

          if($scope.activities1.length == 0 ){
              $("#AcDivEdit").hide();
              $scope.exam_details1.total_exam_marks = "";
              $scope.exam_details1.total_activity_marks = "";
              $scope.exam_details1.exam_passing_marks = "";
              $scope.activities2 = {};
          } else if ($scope.activities1[0].marks > 0){
              $("#AcDivEdit").show();
          } else {
              $("#AcDivEdit").hide();
          }
  ...
  $scope.saveExam = function () {
    $scope.exam_details.total_exam_marks = angular.element('#total_exam_marks').val();
    $scope.exam_details.total_activity_marks = angular.element('#total_activity_marks').val();
    $scope.exam_details.exam_passing_marks = angular.element('#exam_passing_marks').val();
    $scope.exam_details.passing_marks = angular.element('#passing_marks').val();
    $scope.exam_details.activities = $scope.activities;
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    $http.post(base_url + 'examination/saveExamDetails', $scope.exam_details, config).then(
        function (response) {
          if(response.data.status == 'error'){

                $scope.existMessage = response.data.message;
                $("#errorMessage").show();
                Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
              ...
              $scope.exam_details = {};
              $('#passing_marks').val('');
              $('#total_exam_marks').val('');
              $('#total_activity_marks').val('');
              document.getElementById("checkActivities").checked = false;
              $("#AcDiv").hide();
              $("#tableDiv").show();
              $("#add_exam").hide();
              $scope.initExamDetails();
              Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
  ...
  $scope.setID = function(id){
    $scope.examDetailsId = id;
}
  $scope.initExamDetails = function () {

    var table = $('#exam_details_table').DataTable({
                "language": {
                    "decimal":        "",
                    "emptyTable":     '<?php echo lang("no_data_table"); ?>',
                    "info":           '<?php echo lang("data_info"); ?>',
                ...
                ajax: {
                    type: "POST",
                    url: base_url+'examination/getExamDetails',
                    data: '',
                    dataSrc: '',
                },
                columns: [
                    ...
                    {title: '<?php echo lang("lbl_exam_session");?>', data: 'exam_title' },
                    {title: '<?php echo lang("lbl_par_Class");?>', data: 'class_name' },
                    {title: '<?php echo lang("lbl_Section_par");?>', data: 'batch_name' },
                    {title: '<?php echo lang("lbl_subject");?>', data: 'subject_name' },
                    {title: '<?php echo lang("lbl_exam_date");?>', data: 'exam_date' },
                    {title: '<?php echo lang("start_time");?>', data: 'start_time' },
                    {title: '<?php echo lang("end_time");?>', data: 'end_time' },
                    {title: '<?php echo lang("type_dt");?>', data: 'type' },
                    {title: '<?php echo lang("total_marks");?>', data: 'total_marks' },
                    {title: '<?php echo lang("lbl_action");?>', data: '', render: function(data, type, row) {

                            return "<a href='javascript:void(0);' class='btn btn-success btn-circle' ng-click='viewExamDetails("+row.id+")' title='View' style='color: white;'><i class='fa fa-eye'></i></a>"+"<a href='javascript:void(0);' class='btn btn-info btn-circle' ng-click='editExamDetails("+row.id+")' title='Edit' style='color: white;'><i class='fa fa-pencil'></i></a>"+"<a href='javascript:void(0);' class='btn btn-danger btn-circle' ng-click='setID("+row.id+")' title='Delete' data-toggle='modal' data-target='#deleteExamDetails' style='color: white;'><i class='fa fa-trash'></i></a>";
                        } 
                    },
  ...
  $scope.deleteExamDetails = function () {
    ...
    $http.post(base_url + 'examination/deleteExamDetails', $scope.examDetailsId, config).then(
                function (response) {
                if (response.data.deleted == true) {
                        $('#deleteExamDetails').modal('toggle');
                        $scope.initExamDetails();
                        $scope.examDetailsId = "";
                        showNotification('Success', response.data.message, 'success');
                    }
  ...
  $scope.viewExamDetails = function(id){
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    $("#tableDiv").hide();
    $("#view_exam").show();
    $http.post(base_url + 'examination/viewExamDetails', id, config).then(
      function (response) {
          $scope.viewActivities = response.data.activities;
          $scope.viewExam = response.data.data[0];
          Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
      });
  ...
  $scope.getExams = function () {
    $http.post(base_url + 'examination/getSchoolExamsForActiveYear', "", config).then(
      function (response) {
          $scope.exams1 = response.data;
      });
  };

  $scope.editExamDetails = function(id){
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    $("#tableDiv").hide();
    $("#edit_exam").show();
    $("#errorEditMessage").hide();
    $http.post(base_url + 'examination/editExamDetails', id, config).then(
      function (response) {
          $scope.exam_details1.title = response.data.data[0].exam_id;
          $scope.exam_details1.class = response.data.data[0].class_id;
          $scope.exam_details1.section = response.data.data[0].batch_id;
          $scope.exam_details1.subject = response.data.data[0].subject_id;
          $scope.exam_details1.date = response.data.data[0].exam_date;
          var start = toTime(response.data.data[0].start_time);
          // to change time format added by sheraz
          ...
          $scope.exam_details1.start_time = start;
          var end = toTime(response.data.data[0].end_time);
          ...
          $scope.exam_details1.end_time = end;
          $scope.exam_details1.type = response.data.data[0].type;
          $scope.exam_details1.total_marks = parseInt(response.data.data[0].total_marks,10);
          $scope.exam_details1.passing_marks = parseInt(response.data.data[0].passing_marks,10);
          $scope.exam_details1.total_exam_marks = parseInt(response.data.data[0].total_exam_marks,10);
          $scope.exam_details1.total_activity_marks = parseInt(response.data.data[0].totoal_activity_marks,10);
          $scope.exam_details1.exam_passing_marks = parseInt(response.data.data[0].exam_passing_marks,10);
          $scope.exam_details1.id = response.data.data[0].id;
  ...
  $scope.updateExam = function (){
    $scope.exam_details1.activities = $scope.activities1;
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    $http.post(base_url + 'examination/updateExamDetails', $scope.exam_details1, config).then(
      function (response) {
        if(response.data.status == 'error'){

                $scope.existEditMessage = response.data.message;
                $("#errorEditMessage").show();
                Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
  ...
  $scope.search_examDetails = function () {
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    $scope.formModel.class_id = $scope.study.class;
    $scope.formModel.batch_id = $scope.study.section;
    var table = $('#exam_details_table').DataTable({
                "language": {
                    "decimal":        "",
                    "emptyTable":     '<?php echo lang("no_data_table"); ?>',
                ...
                ajax: {
                    type: "POST",
                    url: base_url+'examination/search_examDetails',
                    data: {'formData':$scope.formModel},
                    dataSrc: '',
                },
                columns: [
  ...
  $scope.search_publishExams = function (){
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    $http.post(base_url + 'examination/publishExams', {class_id: $scope.study.class, batch_id: $scope.study.section}, config).then(
      function (response) {
        $scope.publishExams = response.data;
        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
      });
    };

    $scope.publish_result = function (id){
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    $http.post(base_url + 'examination/publish_result1', {id: id}, config).then(
      function (response) {
        showNotification('Success', response.data.message, 'success');
        $scope.search_publishExams();
        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
      });
    };

    $scope.unpublished_result = function (id){
    Loading("body", '<?php echo lang("loading_datatable") ?>', "", "show");
    $http.post(base_url + 'examination/unpublish_result', {id: id}, config).then(
      function (response) {
        showNotification('Success', response.data.message, 'success');
        $scope.search_publishExams();
        Loading("body", '<?php echo lang("loading_datatable") ?>', "", "hide");
