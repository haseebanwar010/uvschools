...
class Study_material extends CI_Controller {
    ...
    public function updateMaterial() {
        ...
        if ($title == "") {
            $response['message'] = "Material Title is required";
    ...
    public function book_shop(){
        ...
        $xcrud->label('class_id',lang('lbl_class'))->label('title',lang('lbl_tbl_title'))->label('availability',lang('lbl_availability'))->label('picture',lang('lbl_picture'));
        $xcrud->change_type('picture','image','',array('height'=>300));
        $xcrud->change_type('price', 'price', '', array('prefix'=>$this->session->userdata('userdata')['currency_symbol']));
