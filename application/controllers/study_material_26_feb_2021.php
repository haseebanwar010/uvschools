...
public function do_upload($fileName, $dirName) {
    ...
    public function newAssignment(){
        ...
        //$subject_codes = implode(',',$subject_code);
        ...
        $this->study_model->newAssignment($title, $type, $class_id, $batches, $subject_id, $files, $school_id, $details, $material_details,$uploaded_by,$uploaded_at, $subject_code, $marks, $due_date, $student_ids);
    ...
    function check_folder_exists($folder_name,$client)
    {
        $sch_id=$this->session->userdata("userdata");
        $sch_id=$sch_id['sh_id'];
