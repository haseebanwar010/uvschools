...
<body ng-app="myschool">
    ...
    <section class="frame" id="wrapper" ng-controller="loginCtrl" class="login-register" style=" height:100%;position:fixed;">
        <div class="login-box " id="loginDiv" >
            <div class="white-box" style="border-top: 9px solid #7B1FA2; border-radius:4px;">

                


                <form class="form-horizontal form-material" ng-submit="onSubmitDefault(loginForm.$valid)" name="loginForm"  id="loginform" novalidate="">
...
<!--                                <div class="checkbox checkbox-primary pull-left p-t-0">
                                ...
                                <a href="javascript:void(0)" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> <?php echo lang('lbl_forgot_pwd'); ?></a> </div>
                            </div>
                            ...
                            <div class="form-group text-center m-t-20">
                                <div class="col-xs-12">
                                    <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit"><?php echo lang('btn_login'); ?></button>
                                </div>
                            </div>
...
<!--                            <div class="form-group m-b-0">
                            ...
                            <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p><?php echo lang('lbl_get_started'); ?> <a href="signup" class="text-primary m-l-5"><b><?php echo lang('lbl_sign_up'); ?></b></a></p>
                        </div>
                    </div>
                            </form>
