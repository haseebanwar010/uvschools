            ...
            <div class="top-left-part">
                ...
                <?php } else { ?>
                    <a class="logo" href="dashboard/">
                        ...
                        <span class="hidden-xs">
                            <!--This is dark logo text-->
                            <img src="uploads/logos/<?php echo $this->session->userdata('userdata')['sh_logo']; ?>" alt="home" class="dark-logo" style="width:96px; max-height: 25px;"/>
                            <!--This is light logo text-->
                            <img src="uploads/logos/<?php echo $this->session->userdata('userdata')['sh_logo']; ?>" alt="home" class="light-logo"  style="width:96px; max-height: 25px;"/>
                        </span>
                    </a>
                <?php } ?>
            </div>
