                    ...
                    <tbody>
                        <tr>
                            <td style="vertical-align: top; padding-bottom:30px;" align="center">
                                    ...
                                    <img src="https://uvschools.com/testing/assets/plugins/images//eliteadmin-logo-dark.png" alt="UV Schools" style="border:none; width:150px;" /><br/>
                        ...
                        <tbody>
                            <tr>
                                <td><b><?php echo $dear_sir; ?></b>
                                    <p><?php echo $msg; ?></p>
                                    <strong style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 22px; color: #fff; background: #00c0c8; border-radius: 60px; text-decoration:none;"> <?php echo $code; ?> </strong>
