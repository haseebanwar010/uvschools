    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title"><?php echo lang('expense_settings') ?></h4>
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?php echo lang('expense_settings') ?></li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        <!-- Page Content start here -->
        <div class="hint"><?php echo lang('help_expense_settings') ?></div>
        <!--.row-->
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="panel-wrapper collapse in" aria-expanded="true">
                        <div class="panel-body">
                            ...
                            <ul class="nav customtab nav-tabs" role="tablist">
                                <li role="presentation" class="nav-item"><a href="#expense_settings" class="nav-link active"
                                                                            aria-controls="profile" role="tab"
                                                                            data-toggle="tab"
                                                                            aria-expanded="true"><span
                                            class="visible-xs"><i class="fa fa-bars"></i></span><span
                                            class="hidden-xs"><?php echo lang('expense_types') ?></span></a>
                                </li>
                                <li role="presentation" class="nav-item"><a href="#categories" class="nav-link"
                                                                            ...
                                                                            aria-expanded="true"><span
                                            class="visible-xs"><i class="fa fa-bars"></i></span><span
                                            class="hidden-xs"><?php echo lang('fixed_expense_categories') ?></span></a>
                                </li>
                                <li role="presentation" class="nav-item"><a href="#nonfixed-categories" class="nav-link"
                                                                            ...
                                                                            aria-expanded="true"><span
                                            class="visible-xs"><i class="fa fa-bars"></i></span><span
                                            class="hidden-xs"><?php echo lang('non_fixed_expense_categories') ?></span></a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="categories">
                                    <?php echo $expense_categories; ?>
                                </div>
                                 <div class="tab-pane" id="nonfixed-categories">
                                    <?php echo $expense_categories_n; ?>
                                </div>
