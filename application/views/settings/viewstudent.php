                                ...
                                <div class="tab-pane active" id="info" >
                                    ...
                                    <form action="" method="post" class="form-material" id="settings" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <h2 class="box-title"><?php echo lang('lbl_student_details') ?></h2>
                                                </div>

                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <img lass="form-control" style="width: 100px;" src="<?php echo base_url(); ?>uploads/user/<?php echo $student[0]->avatar; ?>"/>
                                                        </div>
                                                    </div>
                                                    <!--/span-->
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p><?php echo $student[0]->birthplace; ?></p>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p><?php echo $student[0]->nationality; ?></p>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p><?php echo $student[0]->religion; ?></p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label"><?php echo lang('lbl_roll_no') ?></label>

                                                            <p><?php echo $student[0]->rollno; ?></p>
                                                        </div>
                                                    </div>
                                                    <!--/span-->
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p><?php echo $student[0]->class_id; ?></p>
                                                ...
                                                <div class="row">
                                                    <h2 class="box-title"><?php echo lang('lbl_student_contact_details') ?></h1>
                                                    </div>
                                                    <div class="row">
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p><?php echo $student[0]->contact; ?></p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label"><?php echo lang('lbl_name') ?></label>
                                                                <p><?php echo $student[0]->guardian2_name; ?></p>
                                                    ...
                                                    <!--/span-->
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label"><?php echo lang('lbl_phone') ?></label>
                                                                <p><?php echo $student[0]->guardian2_contact; ?></p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <p><?php echo $student[0]->guardian2_relation; ?></p>
