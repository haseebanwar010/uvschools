...
<div class="clearfix">
  ...
  <div class="iconbb">
  <img class="aligncenter size-full wp-image-19768" src="<?= base_url().'assets/detailed_img/' ?>/multi language-01.png" alt="one" width="105" height="105" />
  </div>
  <div class="textbb">
      <h1><?php echo lang('landing_lbl_multi_language'); ?></h1>
                  
      <p style="text-align: left; font-size: 13px; padding-right: 35px; margin-top:20px;"><?php echo lang('detailed_txt_multilang'); ?></p>
   ...
   <?php if ($this->session->userdata('site_lang') == "arabic" ) { ?>
    ...
    <div class=" col-md-8" >
      <h1><?php echo lang('landing_lbl_multi_language'); ?></h1>
        ...
        <p dir='rtl' style=" font-size: 18px; "><?php echo lang('detailed_txt_multilang'); ?> </p>
...
<section class="kt-listing content-wrapper container">
  <h1 class="kt-listing__heading"><?php echo lang('lbl_features'); echo lang('landing_lbl_multi_language'); ?></h1>
  <?php if ($this->session->userdata('site_lang') == "english" || !$this->session->userdata('site_lang')) {?>
  <ul class="">
    <li class="kt-list__item"><?php echo lang('detailed_f1_multilang'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f2_multilang'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f3_multilang'); ?></li>
 
  </ul>
  <?php  }  
        if ($this->session->userdata('site_lang') == "arabic" ) {?> 
          <ul class="">
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f1_multilang'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f2_multilang'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f3_multilang'); ?></li>
