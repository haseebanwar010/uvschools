...
<div class="clearfix">
  ...
  <div class="iconbb">
  <img class="aligncenter size-full wp-image-19768" src="<?= base_url().'assets/detailed_img/' ?>/multiuser.png" alt="one" width="105" height="105" />
  </div>
  <div class="textbb">
      <h1><?php echo lang('landing_lbl_accounts'); ?></h1>
...
<section class="kt-listing content-wrapper container">
  <h1 class="kt-listing__heading"><?php echo lang('lbl_features'); ?> <?php echo lang('landing_lbl_accounts'); ?></h1>
  <?php if ($this->session->userdata('site_lang') == "english" || !$this->session->userdata('site_lang')) {?>
  <ul class="kt-list">
    <li class="kt-list__item"><?php echo lang('detailed_f1_accounts'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f2_accounts'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f3_accounts'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f4_accounts'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f5_accounts'); ?></li>
  </ul>
  <?php  }  
        if ($this->session->userdata('site_lang') == "arabic" ) {?> 
          <ul class="kt-list">
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f1_accounts'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f2_accounts'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f3_accounts'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f4_accounts'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f5_accounts'); ?></li>
  </ul>
  <?php } ?>
</section>
<div class="container">
