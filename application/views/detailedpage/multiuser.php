...
<div class="clearfix">
  ...
  <div class="iconbb">
    <img class="aligncenter size-full wp-image-19768" src="<?= base_url().'assets/detailed_img/' ?>/multi user-01.png" alt="one" width="105" height="105" />
  </div>
  <div class="textbb">
      <h1><?php echo lang('landing_lbl_multiuser'); ?></h1>
                  
        <p style="text-align: left; font-size: 13px; padding-right: 35px;"><?php echo lang('detailed_txt_multiuser'); ?> </p>
   ...
   <?php if ($this->session->userdata('site_lang') == "arabic" ) { ?>
    ...
    <div class=" col-md-8" >
      <h1><?php echo lang('landing_lbl_multiuser'); ?></h1>
        ...
        <p dir='rtl' style=" font-size: 18px; "><?php echo lang('detailed_txt_multiuser'); ?> </p>
...
<section class="kt-listing content-wrapper container">
  <h1 class="kt-listing__heading"><?php echo lang('lbl_features'); ?> <?php echo lang('landing_lbl_multiuser');  ?> </h1>
  <?php if ($this->session->userdata('site_lang') == "english" || !$this->session->userdata('site_lang')) {?>
  <ul class="kt-list">
    <li class="kt-list__item"><?php echo lang('detailed_f1_multiuser'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f2_multiuser'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f3_multiuser'); ?></li>
    <li class="kt-list__item"><?php echo lang('lbl_admin'); ?></li>
    <li class="kt-list__item"><?php echo lang('lbl_teacher'); ?></li>
    <li class="kt-list__item"><?php echo lang('lbl_parent_dsh'); ?></li>
    <li class="kt-list__item"><?php echo lang('menu_students'); ?></li>
  </ul>
  <?php  }  
        if ($this->session->userdata('site_lang') == "arabic" ) {?> 
    <ul class="kt-list">
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f1_multiuser'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f2_multiuser'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f3_multiuser'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('lbl_admin'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('lbl_teacher'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('lbl_parent_dsh'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('menu_students'); ?></li>
  </ul>
  <?php } ?>
</section>
<div class="container">
