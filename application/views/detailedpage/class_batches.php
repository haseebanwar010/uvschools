...
<div class="clearfix">
  ...
  <div class="iconbb">
  <img class="aligncenter size-full wp-image-19768" src="<?= base_url().'assets/detailed_img/' ?>/classesbatches.png" alt="one" width="105" height="105" />
  </div>
  <div class="textbb">
      <h1><?php echo lang('landing_lbl_classes_batches'); ?></h1>
                  
      <p style="text-align: left; font-size: 13px; padding-right: 35px;"><?php echo lang('detailed_txt_class_batches'); ?></p>
   ...
   <?php if ($this->session->userdata('site_lang') == "arabic" ) { ?>
    ...
    <div class=" col-md-8" >
      <h1><?php echo lang('landing_lbl_classes_batches'); ?></h1>
        ...
        <p dir='rtl' style=" font-size: 18px; "><?php echo lang('detailed_txt_class_batches'); ?> </p>
...
<section class="kt-listing content-wrapper container">
  <h1 class="kt-listing__heading"><?php echo lang('lbl_features'); ?> <?php echo lang('landing_lbl_classes_batches'); ?></h1>
  <?php if ($this->session->userdata('site_lang') == "english" || !$this->session->userdata('site_lang')) {?>
  <ul class="kt-list">
    <li class="kt-list__item"><?php echo lang('detailed_f1_class_batches'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f2_class_batches'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f3_class_batches'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f4_class_batches'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f5_class_batches'); ?></li>
  </ul>
  <?php  }  
        if ($this->session->userdata('site_lang') == "arabic" ) {?> 
         <ul class="kt-list">
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f1_class_batches'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f2_class_batches'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f3_class_batches'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f4_class_batches'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f5_class_batches'); ?></li>
  </ul>
  <?php } ?>
</section>
<div class="container">
