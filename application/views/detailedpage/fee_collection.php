...
<div class="clearfix">
  ...
  <div class="iconbb">
  <img class="aligncenter size-full wp-image-19768" src="<?= base_url().'assets/detailed_img/' ?>/fee method-01.png" alt="one" width="105" height="105" />
  </div>
  <div class="textbb">
      <h1><?php echo lang('landing_lbl_fee_collection'); ?></h1>
                  
      <p style="text-align: left; font-size: 13px; padding-right: 35px;"><?php echo lang('detailed_txt_fee_collection'); ?></p>
   ...
   <?php if ($this->session->userdata('site_lang') == "arabic" ) { ?>
    ...
    <div class=" col-md-8" >
      <h1><?php echo lang('landing_lbl_fee_collection'); ?></h1>
        ...
        <p dir='rtl' style=" font-size: 18px; "><?php echo lang('detailed_txt_fee_collection'); ?> </p>
...
<section class="kt-listing content-wrapper container">
  <h1 class="kt-listing__heading"><?php echo lang('lbl_features'); ?> <?php  echo lang('landing_lbl_fee_collection'); ?></h1>
  <?php if ($this->session->userdata('site_lang') == "english" || !$this->session->userdata('site_lang')) {?>
  <ul class="kt-list">
    <li class="kt-list__item"><?php echo lang('detailed_f1_fee_collection'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f2_fee_collection'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f3_fee_collection'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f4_fee_collection'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f5_fee_collection'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f6_fee_collection'); ?></li>
  </ul>
  <?php  }  
        if ($this->session->userdata('site_lang') == "arabic" ) {?> 
          <ul class="kt-list">
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f1_fee_collection'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f2_fee_collection'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f3_fee_collection'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f4_fee_collection'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f5_fee_collection'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f6_fee_collection'); ?></li>
  </ul>
  <?php } ?>
</section>
<div class="container">
<h2><?php echo lang('lbl_other_features'); ?></h2>
  <br>
   ...
   <?php if ($this->session->userdata('site_lang') == "english" || !$this->session->userdata('site_lang')) {?>
      ...
      <div class="slide"><a href="<?= base_url();?>multiuser/dattendance" class="title"><img class="slide_icon" src="<?= base_url().'assets/iconsnew/' ?>/attendance.png" ><div class="buttonContainer1"> <a class="button2" href="<?= base_url();?>multiuser/dattendance" ><?php echo lang('landing_lbl_student_employee_ttendance'); ?></a></div></a></div>
      ...
      <div class="slide"><a href="<?= base_url();?>multiuser/dattendance" class="title"><img class="slide_icon" src="<?= base_url().'assets/iconsnew/' ?>/attendance.png" ><div class="buttonContainer1"> <a class="button2" href="<?= base_url();?>multiuser/dattendance" style="font-size: 18px; padding-left:20px;"><?php echo lang('landing_lbl_student_employee_ttendance'); ?></a></div></a></div>
