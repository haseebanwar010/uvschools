...
<div class="clearfix">
  ...
  <div class="textbb">
      <h1><?php echo lang('reports_all'); ?></h1>
                  
      <p style="text-align: left; font-size: 13px; padding-right: 35px;margin-top:20px;"><?php echo lang('detailed_txt_reports'); ?></p>
   ...
   <?php if ($this->session->userdata('site_lang') == "arabic" ) { ?>
    ...
    <div class=" col-md-8" >
      <h1><?php echo lang('reports_all'); ?></h1>
        ...
        <p dir='rtl' style=" font-size: 18px; "><?php echo lang('detailed_txt_reports'); ?> </p>
...
<section class="kt-listing content-wrapper container">
  <h1 class="kt-listing__heading"><?php echo lang('lbl_features'); ?> <?php echo lang('reports_all');  ?></h1>
  <?php if ($this->session->userdata('site_lang') == "english" || !$this->session->userdata('site_lang')) {?>
  <ul class="kt-list">
    <li class="kt-list__item"><?php echo lang('detailed_f1_reports'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f2_reports'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f3_reports'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f4_reports'); ?></li>
    <li class="kt-list__item"><?php echo lang('lbl_fee_reprot'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f5_reports'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f6_reports'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f7_reports'); ?></li>
  </ul>
  <?php  }  
