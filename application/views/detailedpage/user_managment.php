...
<div class="clearfix">
  ...
  <div class="textbb">
      <h1><?php echo lang('landing_lbl_user_managment'); ?></h1>
                  
      <p style="text-align: left; font-size: 13px; padding-right: 35px; margin-top:20px;"><?php echo lang('detailed_txt_user_managment'); ?></p>
   ...
   <?php if ($this->session->userdata('site_lang') == "arabic" ) { ?>
    ...
    <div class=" col-md-8" >
      <h1><?php echo lang('landing_lbl_user_managment'); ?></h1>
        ...
        <p dir='rtl' style=" font-size: 18px; "><?php echo lang('detailed_txt_user_managment'); ?> </p>
...
<section class="kt-listing content-wrapper container">
  <h1 class="kt-listing__heading"><?php echo lang('lbl_features'); ?> <?php echo lang('landing_lbl_user_managment'); ?> </h1>
  <?php if ($this->session->userdata('site_lang') == "english" || !$this->session->userdata('site_lang')) {?>
  <ul class="kt-list">
    <li class="kt-list__item"><?php echo lang('detailed_f1_user_managment'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f2_user_managment'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f3_user_managment'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f4_user_managment'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f5_user_managment'); ?></li>
  </ul>
  <?php  }  
        if ($this->session->userdata('site_lang') == "arabic" ) {?> 
          <ul class="kt-list">
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f1_user_managment'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f2_user_managment'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f3_user_managment'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f4_user_managment'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f5_user_managment'); ?></li>
  </ul>
  <?php } ?>
</section>
<div class="container">
