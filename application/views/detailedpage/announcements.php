...
<?php 
  ...
  <div class="textbb">
      <h1 class="detail-heading"><?php echo lang('lbl_announcements'); ?></h1>
        <p style="text-align: left; font-size: 13px; padding-right: 35px;"><?php echo lang('detailed_txt_announcements'); ?></p>
        <div class='bble'>
  ...
  <div class=" col-md-8" >
      <h1><?php echo lang('lbl_announcements'); ?></h1>
     
                               
        <p dir='rtl' style=" font-size: 18px; "><?php echo lang('detailed_txt_announcements'); ?> </p>
...
<section class="kt-listing content-wrapper container">
  <h1 class="kt-listing__heading"><?php echo lang('lbl_features'); ?> <?php echo lang('lbl_announcements'); ?></h1>
  <?php if ($this->session->userdata('site_lang') == "english" || !$this->session->userdata('site_lang')) {?>
  <ul class="kt-list">
    <li class="kt-list__item"><?php echo lang('detailed_f1_announcements'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f2_announcements'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f3_announcements'); ?></li>
    <li class="kt-list__item"><?php echo lang('detailed_f4_announcements'); ?></li>

  </ul>
  <?php  }  
        if ($this->session->userdata('site_lang') == "arabic" ) {?> 
  <ul class="kt-list">
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f1_announcements'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f2_announcements'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f3_announcements'); ?></li>
    <li class="kt-list__item" style="font-size: 17px;"><?php echo lang('detailed_f4_announcements'); ?></li>
