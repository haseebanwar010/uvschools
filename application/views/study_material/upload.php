                        ...
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="general">
                                    ...
                                    <div class="row">
                                        <button class="fcbtn btn  btn-primary" style="margin-bottom: 10px; margin-left: auto; margin-right: 20px;" data-toggle="modal" data-target="#upload" ng-click="resetModal()"><?php echo lang('lbl_upload') ?></button>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <label class="control-label" style="padding-left: 18px;"><?php echo lang('lbl_marks'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                       <label class="control-label pull-right"><?php echo lang('total_marks'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                    ...
                                                    <table>
                                                      ...
                                                      <!--<td ng-repeat="thumbx_link in details.thumbnail_links" style="padding: 5px">-->
                                                        <td ng-repeat="(key,file) in study2.old_files" style="width: 149px;">
                                                            ...
                                                            <div ng-if="['mp3','MP3', 'avi', 'AVI', 'aac', 'AAC'].includes(file.name.split('.').pop().toLowerCase())">
                                                    ...
                                                    <div style="width:100%; overflow-x: auto;">
                                                          ...
                                                          <!--<td ng-repeat="thumbx_link in study2.thumbnail_links" style="padding: 5px">-->
                                                            <td ng-repeat="(key,f) in study2.old_files" style="width: 149px;">
                                                                ...
                                                                <div ng-if="study2.file_names[key].substr(study2.file_names[key].lastIndexOf('.') + 1) == 'mp3' || study2.file_names[key].substr(study2.file_names[key].lastIndexOf('.') + 1) == 'MP3' || study2.file_names[key].substr(study2.file_names[key].lastIndexOf('.') + 1) == 'avi' || study2.file_names[key].substr(study2.file_names[key].lastIndexOf('.') + 1) == 'AVI' || study2.file_names[key].substr(study2.file_names[key].lastIndexOf('.') + 1) == 'aac' || study2.file_names[key].substr(study2.file_names[key].lastIndexOf('.') + 1) == 'AAC' ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div ng-if="study7.storage_type == 1">
                                                            <!--////////////////////////////////////////////////////-->
                                                            <div style="width:100%; overflow-x: auto;">
                                                                <table>
                                                                    <tr style="overflow-x: auto;" class="test">
                                                          
                                                                        <td ng-repeat="(key,file) in study7.old_files" style="width: 149px;">
                                                                            ...
                                                                            <div style="text-align: center !important; width: 141px; overflow: hidden; text-overflow: ellipsis;">
                                                                                <!--<a  href="<?php echo base_url() ?>uploads/study_material/{{file.name}}" target="_blank">{{study7.file_names[key]}}</a> -->
                                                                                
                                                                                <a  href="<?php echo base_url() ?>uploads/study_material/{{file.name}}" target="_blank" ng-if="study7.file_names[key]!=''">{{study7.file_names[key]}}</a>
                                                                                <a  href="<?php echo base_url() ?>uploads/study_material/{{file.name}}" target="_blank" ng-if="study7.file_names==''">{{file.name}}</a>
                                                                                
                                                                                <!--<a  href="<?php echo base_url() ?>uploads/study_material/{{file}}" target="_blank" ng-if="details.file_names[key]!=''">{{details.file_names[key]}}</a> -->
                                                                                <!--<a  href="<?php echo base_url() ?>uploads/study_material/{{file}}" target="_blank" ng-if="details.file_names==''">{{file}}</a>-->
                                                                                <button class="btn btn-link text-danger" ng-click="removeFileAssignment(file.name)" type="button">Remove</button>
                                                                            </div>
                                                        ...
                                                        <div ng-if="study7.storage_type == 2" >
                                                            <!--///////////////////////////////////////////////-->
                                                            <div style="width:100%; overflow-x: auto;">
                                                                <table>
                                                                    <tr style="overflow-x: auto;" class="test">
                                                              
                                                          <!--<td ng-repeat="thumbx_link in study7.thumbnail_links" style="padding: 5px">-->
                                                                        <td ng-repeat="(key,f) in study7.old_files" style="width: 149px;">
                                                                
                                                                
                                                                            <div ng-if="study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'mp4' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'MP4' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'avi' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'AVI' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'flv' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'FLV' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'wmv' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'WMV' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'mov' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'MOV' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'webm'  || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'WEBM' ">
                                                                                <img class="client-img img-thumbnail" src="assets/googledrive_guide/images/videoicon.png" style="height:150px; width:320px; border-radius:8px;" />
                                                                            </div>
                                                            
                                                                            <div ng-if="study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'pdf' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'PDF' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'doc' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'DOC' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'docx' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'DOCX' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'ppt' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'PPT' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'pptx' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'PPTX' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'png' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'PNG' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'tif' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'TIF' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'tiff' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'TIFF' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'bmp' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'BMP' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'jpg' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'JPG' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'jpeg' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'JPEG' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'gif' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'GIF' || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'eps'  || study7.file_names[key].substr(study7.file_names[key].lastIndexOf('.') + 1) == 'EPS' ">
                                                                                <img class="client-img img-thumbnail" ng-src="{{study7.thumbnail_links[key]}}" style="height:150px; width:320px; border-radius:8px;" />
                                                                            </div>
                                                                            <div style="text-align: center !important; width: 141px; overflow: hidden; text-overflow: ellipsis;">
                                                                                <a  href="{{study7.filesurl[key]}}" target="_blank">{{study7.file_names[key]}}</a>
                                                                                <button class="btn btn-link text-danger" ng-click="removeFileAssignment(f.name)" type="button">Remove</button>
                                                                            </div> 
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                    ...
                                                    <div class="col-md-6">
                                                     ...
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div
                                                            class="dropzone"
                                                            id="my-awesome-assignment-dropzone" dropzone="dropzoneConfigAssignmentEdit"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div ng-if="study8.storage_type == 1">
                                                            <!--////////////////////////////////////////////////////-->
                                                            <div style="width:100%; overflow-x: auto;">
                                                                <table>
                                                                    <tr style="overflow-x: auto;" class="test">
                                                          
                                                                        <td ng-repeat="(key,file) in study8.old_files" style="width: 149px;">
                                                                            ...
                                                                            <div style="text-align: center !important; width: 141px; overflow: hidden; text-overflow: ellipsis;">
                                                                                <!--<a  href="<?php echo base_url() ?>uploads/study_material/{{file.name}}" target="_blank">{{study8.file_names[key]}}</a> -->
                                                                                
                                                                                <a  href="<?php echo base_url() ?>uploads/study_material/{{file.name}}" target="_blank" ng-if="study8.file_names[key]!=''">{{study8.file_names[key]}}</a>
                                                                                <a  href="<?php echo base_url() ?>uploads/study_material/{{file.name}}" target="_blank" ng-if="study8.file_names==''">{{file.name}}</a>
                                                                                
                                                                                <!--<a  href="<?php echo base_url() ?>uploads/study_material/{{file}}" target="_blank" ng-if="details.file_names[key]!=''">{{details.file_names[key]}}</a> -->
                                                                                <!--<a  href="<?php echo base_url() ?>uploads/study_material/{{file}}" target="_blank" ng-if="details.file_names==''">{{file}}</a>-->
                                                                                <button class="btn btn-link text-danger" ng-click="removeFileHomework(file.name)" type="button">Remove</button>
                                                                            </div>
                                                        ...
                                                        <div ng-if="study8.storage_type == 2" >
                                                            <!--///////////////////////////////////////////////-->
                                                            <div style="width:100%; overflow-x: auto;">
                                                                <table>
                                                                    <tr style="overflow-x: auto;" class="test">
                                                              
                                                                        <td ng-repeat="(key,f) in study8.old_files" style="width: 149px;">
                                                                
                                                                
                                                                            <div ng-if="study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'mp4' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'MP4' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'avi' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'AVI' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'flv' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'FLV' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'wmv' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'WMV' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'mov' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'MOV' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'webm'  || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'WEBM' ">
                                                                                <img class="client-img img-thumbnail" src="assets/googledrive_guide/images/videoicon.png" style="height:150px; width:320px; border-radius:8px;" />
                                                                            </div>
                                                            
                                                                            <div ng-if="study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'pdf' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'PDF' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'doc' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'DOC' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'docx' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'DOCX' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'ppt' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'PPT' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'pptx' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'PPTX' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'png' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'PNG' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'tif' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'TIF' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'tiff' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'TIFF' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'bmp' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'BMP' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'jpg' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'JPG' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'jpeg' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'JPEG' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'gif' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'GIF' || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'eps'  || study8.file_names[key].substr(study8.file_names[key].lastIndexOf('.') + 1) == 'EPS' ">
                                                                                <img class="client-img img-thumbnail" ng-src="{{study8.thumbnail_links[key]}}" style="height:150px; width:320px; border-radius:8px;" />
                                                                            </div>
                                                                            <div style="text-align: center !important; width: 141px; overflow: hidden; text-overflow: ellipsis;">
                                                                                <a  href="{{study8.filesurl[key]}}" target="_blank">{{study8.file_names[key]}}</a>
                                                                                <button class="btn btn-link text-danger" ng-click="removeFileHomework(f.name)" type="button">Remove</button>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                    ...
                                                    <div class="col-md-6">
                                                     ...
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div
                                                            class="dropzone"
                                                            id="my-awesome-homework-dropzone" dropzone="dropzoneConfigHomeworkEdit"></div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 10px" ng-show="details.files[0].length > 0">
                            <div class="col-md-12">
                                <ul >
                                    <!--////For storage type 2(Local Drive)////-->
                                    <div ng-if="details.storage_type == 1">
                                ...
                                <!--////For storage type 2(Google Drive)////-->
                                <div ng-if="details.storage_type == 2" style="overflow-x: auto;">
