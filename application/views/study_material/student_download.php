...
<div>
    <!-- Page Content -->
    <div id="page-wrapper">
        <div class="container-fluid" ng-controller="downloadParentController" ng-init="initSubjectsForStudent();">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="general">
                                        ...
                                        <div class="well" id="download_search_filter">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" ng-model="date" class="form-control mydatepicker-autoclose" placeholder="<?php echo "Select date"; ?>" style="border-left: none;border-right:none;border-top:none;  "/>
                                            ...
                                            <!--<div class="row">-->
                                            <!--    <div class="col-md-12">-->
                                            <!--        <button class="btn btn-sm btn-primary" ng-click="filterForStudent()"><?php echo lang('search'); ?></button>-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button class="btn btn-sm btn-primary" ng-click="filterForStudent()" ng-disabled="!(!!subject_id || !!type  || !!date)"><?php echo lang('search'); ?></button>
                                                    <button class="btn btn-sm btn-default" ng-click="removeFilter_student()"><?php echo lang('remove_filters'); ?></button>
                                                </div>
                                            </div>
                                        </div>
