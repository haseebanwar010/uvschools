...
<div>
    <!-- Page Content -->
    <div id="page-wrapper">
        <div class="container-fluid" ng-controller="bookshopCtrl" ng-init="getBookshopForStudent()">
            ...
            <!-- <div class="well" style="background:#e4e7ea;">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control js-example-basic-multiple" multiple="multiple" style="width:100%" ng-model="selectedClass">
              ...
              <div class="row">
                <div class="col-md-12"> -->
                    ...
                    <!-- <button class="btn btn-primary text-white" ng-click="getBookshop()" ng-disabled="selectedClass=='all'||selectedClass.length==0"><?php echo lang('search') ?></button>
