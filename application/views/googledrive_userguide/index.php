                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Click <a href="https://console.cloud.google.com/" target="_blank"><button type="button" class="bnt btn-primary" style="padding-left: 10px; padding-right: 10px; border-radius: 5px;">here</button></a> and Google API screen will appear, than click on the highlighted portion on the top blue header.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-1.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Click on the "New Project" that is highlighted in the image below.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-2.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Now just need to type the "Project Name" as your "School Name" and click on "Create" button.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-3.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Now Project created successfully and notification will be received as highlighted in the notification then click on your desire Project.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-4.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">There is a "Menu Button" on the top left corner click on it and then select "APIs and services".</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-5.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Now click on the "ENABLE APIS AND SERVICES" on the top header.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-6.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Now type here "google drive api" and select from drop down menu.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-7.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Select "Google Drive API" from the list.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-8.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Click on "Enable" Button to enable google drive api.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-9.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Now Click on the "Configure Consent Screen" or select "OAuth consent screen" from the sidebar, then click on "external" and press "Create" button.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-99.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                            <img src="assets/googledrive_guide/images/ub-11.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Now type "School Name" in the App name and select you email Id that you used for google drive, then type below Email Id in the "Developers Email Address" and click on "Save & continue" three times and then click on "Back to Dashboard" button.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label" style="margin-top: 15px;"><strong>Developers email address :</strong> </label>
                                                <input type="text" class="form-control" style="border-left: none;border-right:none;border-top:none;" value="uvschoolsmac@gmail.com" />
                                            </div>
                                            <img src="assets/googledrive_guide/images/ub-12.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                            <img src="assets/googledrive_guide/images/ub-13.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Now click on the "Publish App" button & then confirm.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-14.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                            <img src="assets/googledrive_guide/images/ub-15.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p style="margin-top: 8px;">Click on "Credentials from the "side bar" and then click on "Create Credentials" from the header and then select OAuth Client Id from the drop down menu.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-10.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>
                                ...
                                <br>
                                <ul>
                                    <li><strong>Step #15</strong></li> 
                                    <p style="margin-top: 8px;">Now select "Web Application" from the drop down menu.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-16.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <br>
                                <ul>
                                    <li><strong>Step #16</strong></li> 
                                    <p style="margin-top: 8px;">Now add "URL & Authorized redirect URL" as given below and press "Create" button.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label" style="margin-top: 15px;"><strong>Authorized Javascript Origins URL :</strong> </label>
                                                <input type="text" class="form-control" style="border-left: none;border-right:none;border-top:none;" value="https://uvschools.com" />
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label" style="margin-top: 15px;"><strong>Authorized Redirect URL :</strong> </label>
                                            ...
                                            <img src="assets/googledrive_guide/images/ub-17.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <br>
                                <ul>
                                    <li><strong>Step #17</strong></li> 
                                    <p style="margin-top: 8px;">Now click on the "Ok" button then download the token file from the highlighted download icon.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/ub-18.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                            <img src="assets/googledrive_guide/images/ub-19.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <!--<ul>-->
                                <!--    <li><strong>Step #2</strong></li> -->
                                <!--    <p style="margin-top: 8px;">Click <a href="https://console.cloud.google.com/" target="_blank"><button type="button" class="bnt btn-primary" style="padding-left: 10px; padding-right: 10px; border-radius: 5px;">here</button></a> and Google API screen will appear, than click on the button named as "Enable The Drive API"</p>-->
                                <!--    <div class="row">-->
                                <!--        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">-->
                                <!--            <img src="assets/googledrive_guide/images/ub-20.png" alt="gmail" class="img-responsive img-thumbnail" style="width: 100%;">-->
                                <!--        </div>-->
                                <!--    </div>-->
                                <!--</ul>  -->
                    ...
                    <section id="line2" class="section">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul>
                                    <li><strong>Step #2</strong></li>
                                    <p style="margin-top: 8px;">Now click on "Enable Google Drive" than select your gmail account that you use before, than "Allow or Check" all "Permissions" as shown below & you successfully done with Google Drive integration.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <img src="assets/googledrive_guide/images/ub-20.png" class="img-responsive img-thumbnail" style="width: 100%;">
                                            <p> </p><br>
