                               ...
                               <h2 class="dark-text">Introduction<hr></h2>
                                <div class="row">
                                    ...
                                    <div class="col-md-12 full">
                                        ...
                                        <hr>
                                        <div>
                                            <p>First of all, Thank you so much for being a part of <strong>UVSchools</strong>.</p>

                                            <p>This documentation is to help you regarding each step of Google Drive API Integration. Please go through the documentation carefully to understand how to integrate from google drive console and from UVSchools settings.</p>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul>
                                    ...
                                    <p>Login your desire Gmail Account</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/gmail_login.png" alt="gmail" class="img-responsive img-thumbnail">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p>Click <a href="https://developers.google.com/drive/api/v3/quickstart/php" target="_blank">here</a> and Google API screen will appear, than click on the button named as "Enable The Drive API"</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/console_1.png" alt="gmail" class="img-responsive img-thumbnail">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p>Type your school name in the field of "Project Name" and press next</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/console_2.png" alt="gmail" class="img-responsive img-thumbnail">
                                        </div>
                                    </div>
                                </ul>             
                                ...
                                <ul>
                                    ...
                                    <p>Select "Web Browser" from the dropdown menu and copy below given url & press create button & than press done.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                           URL:
                                          <pre class="brush: html; highlight: [2,4]">
                                            ...
                                            <img src="assets/googledrive_guide/images/console_3.png" alt="gmail" class="img-responsive img-thumbnail">
                                        </div>
                                    </div>
                                </ul>    
                                ...
                                <ul>
                                    ...
                                    <p>Click <a href="https://console.developers.google.com" target="_blank">here</a> and Google Console screen will appear than select your project name on the top left corner of the screen. After that click on "Credentials" in the sidebar.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/console_4.png" alt="gmail" class="img-responsive img-thumbnail"/>
                                        </div>
                                    </div>
                                </ul>     
                                ...
                                <ul>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/console_5.png" alt="gmail" class="img-responsive img-thumbnail">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    ...
                                    <p>Click on "Add URL" in the section of "Authorised redirect URIs" and copy url given below than press Save button & download file.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            URL:
                                            <pre class="brush: html; highlight: [2,4]">
                                            ...
                                            <img src="assets/googledrive_guide/images/console_6.png" alt="gmail" class="img-responsive img-thumbnail">
                                        </div>
                                    </div>
                                </ul>
                    ...
                    <section id="line2" class="section">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul>
                                    <li><strong>Step #1</strong></li>
                                    <p>Login UVSchools with admin account and click on settings than google drive and upload file that downloaded before & press save button</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/console_7.png" alt="gmail" class="img-responsive img-thumbnail">
                                        </div>
                                    </div>
                                </ul>  
                                ...
                                <ul>
                                    <li><strong>Step #2</strong></li>
                                    <p>Click on button named as "Enable Google Drive" and select your gmail account that you use before, than allow all permissions and press allow & you done with Google Drive integration.</p>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <img src="assets/googledrive_guide/images/console_8.png" alt="gmail" class="img-responsive img-thumbnail">
                                            <p> </p><br>
                                            <img src="assets/googledrive_guide/images/console_9.png" alt="gmail" class="img-responsive img-thumbnail">
                                            <p> </p><br>
                                            <img src="assets/googledrive_guide/images/console_10.png" alt="gmail" class="img-responsive img-thumbnail">
                                        </div>
                                    </div>
                                </ul>  
