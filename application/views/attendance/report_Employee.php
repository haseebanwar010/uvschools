...
<!-- Page Content -->
<div id="page-wrapper" ng-controller="reportEmployeeController">
    <div class="container-fluid">
        ...
        <!--.row-->
        <div class="white-box well" id="emp_attReport_search_filter">
        ...
        <div class="white-box attendance-table" ng-show="finalReport[0].attendance">
            <div class="row">
                <div class="col-md-12 p-b-10" style="text-align: right;">
                    <button type="button" class="btn btn-sm btn-default" onclick="printD2()"><i class="fa fa-print"></i></button>
                </div>
