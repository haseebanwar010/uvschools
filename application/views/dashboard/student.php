        ...
        <div class="hint" >
          <ul class="nav nav-tabs row" id="myTab" role="tablist">
            <li class="nav-item col-lg-4 col-md-4 col-sm-4 col-xs-4" style="text-align: center;">
              <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><?php echo lang('study_material');?></a>
            </li>
            <!-- <li class="nav-item col-lg-4 col-md-4 col-sm-4 col-xs-4" style="text-align: center;">
          ...
          <div class="tab-content" id="myTabContent">
            ...
            if(count($materials)<1){ ?>
                 <div style="text-align: center;">
                   <h2><?php echo lang('lbl_no_study_material');?></h2>
                 </div>
            <?php  } else{
             $id=0;
             foreach($materials as $mat){ 
              ...
              <div class="card" style="height:340px"  >
                    ...
                    <p style="font-size: 16px; margin-top:5%;margin-bottom:-7px; font-weight:bold;">Teacher : <span style="font-size: 14px;"><?php echo $mat['name']; ?></span></p>
                        <div class="card-body">
                          <h5 class="card-title"><?php echo lang('lbl_tbl_title'); ?>: <?php echo $mat['title']; ?></h5>
                          <!-- <p class="card-text"><?php echo $mat['content_type']; ?></p> -->
                          <p class="card-title"><?php echo lang('lbl_details'); ?>:</p>
                         ...
                         <div class="slide"> <a href="<?= base_url().'uploads/study_material/'.$file ?>" target="_blank" ><img class="slide_icon" style="height: 40px; width:35px" src="<?= base_url().'assets/iconsnew/icons' ?>/pdf_icon.png"></a> </div>
                            ...
                            <?php }else if($ext =='webm' || $ext == 'mp4' || $ext == 'mov' || $ext == 'wmv' || $ext == 'flv' || $ext == 'avi'){ ?>
                              ...
                              <?php }else if($ext == 'ppt' || $ext == 'pptx') { ?>
                                ...
                                <?php }else if($ext == 'jpg' || $ext == 'png' || $ext == 'JPG' || $ext == 'PNG' || $ext == 'jpeg' || $ext == 'JPEG') { ?>
                                  <div class="slide"> <a href="<?= base_url().'uploads/study_material/'.$file ?>" target="_blank" data-lightbox="image-<?php echo $code; ?>" ><img class="slide_icon" style="height: 40px; width:35px" src="<?= base_url().'assets/iconsnew/icons' ?>/image.png"></a><p style="margin-left: 5%;"><?php echo $count; ?></p>  </div>
                                <?php } else if($file == "") { ?>
                          ...
                          <a href="#" id="<?php echo $id; ?>" style="float: left;" data-toggle="modal" data-target="#details" ng-click="detailsStd_studymaterial_dashbaord('<?php echo $id; ?>')">View Details</a>
                          <?php $id = $id + 1; ?>
                          <p class="card-text" style="float: right;"><small class="text-muted"><?php echo $mat['uploaded_time']; ?></small></p>
                        </div>
              </div>
          <?php }} ?>
              </div>
