            ...
            <div class="col-md-9" ng-controller="conversation" ng-init="conver.id='<?php echo $con_info->id;?>';init();">
                <div class="white-box">
                    ...
                    <div class="white-box" ng-repeat="mess in messages">
                        ...
                        <img class="pull-left media-object thumb-md img-circle" ng-src="<?php echo base_url() ?>uploads/user/{{mess.avatar}}" alt="">
                       ...
                       <div class="col-md-1">
                           ...
                           <div class="col-md-11">
                            ...
                            <div class="pull-right">
                                ...
                                <button class="btn btn-default" ng-click="back()" id="discard"><i class="fa fa-times"></i> <?php echo lang('btn_cancel');?> </button>
                            </div>
                        </div>
                    </div>
                </div>
