...
<div id="page-wrapper" ng-controller="feeCollectionparentController">
    ...
    <div class="row" id="feecollection" ng-init="initAcademicYears()">
        <div class="col-md-12"> 
            <div class="white-box">
                <form class="form-material" id="feeCollection_search_filter" name="feecollectionFilterForm" ng-submit="fetchFeeCollectionsStudent(<?php echo $this->session->userdata("userdata")["user_id"];?>)" novalidate="">
                    <!--/row-->
                    <div class="row">
                        ...
                        <div class="col-md-3" id="feeFilterAcademicYears">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="academic_year_id" ng-model="fcModel.academic_year_id" required="" >
                        ...
                        <!-- <div class="col-md-3" id="feeFilterChilds">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="student_id" ng-model="fcModel.student_id" required="">
                                    <option value="<?php echo $this->session->userdata("userdata")["user_id"];?>"><?php echo lang('lbl_select_child') ?></option>
                                    <option ng-repeat="cls in parentchild" value="{{ cls.student_id }}">{{ cls.student_id }}</option>
                                </select>
                            </div>
                        </div> -->
                                ...
                                <table id="myTable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="(key,rcd) in stdFeeRecords">
                                            ...
                                            <td><?php echo $this->session->userdata('userdata')['currency_symbol'] ?>{{rcd[0].discounted_amount}}</td>
