                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-wrapper collapse in" aria-expanded="true">
                            <div class="panel-body m-l-20 m-r-20" ng-controller="importCtrl" >
                                <!--                                <form name="stdAddmissionForm" ng-submit="onSubmit(stdAddmissionForm.$valid,image2.resized,image3.resized)" novalidate="" class="form-material">-->
                                 ...
                                 <form name="csvStudentForm" id="csvStudentForm" ng-submit="onSubmit(save.$valid,image2.resized,image3.resized)" novalidate="" class="form-material">
                                     <div class="form-body" >{{showstd.fname}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="firstName" ng-model="showstd.fname" class="form-control" placeholder="John " required="">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="lastName" ng-model="showstd.lname" class="form-control" placeholder="doe" required="">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control mydatepicker-autoclose" ng-model="formModel.dob" placeholder="dd/mm/yyyy" required="">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="country" ng-model="formModel.nationality" ng-init="formModel.nationality=''" class="form-control" >
