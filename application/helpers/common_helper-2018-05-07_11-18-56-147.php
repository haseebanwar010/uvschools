...
function render_universal_tags($form,$html){
    ...
    $tags["school_country"] = $ci->admin_model->dbSelect("country","school"," id='$school_id' "); //froms ession
    $tags["school_city"] = 'pending'; //froms ession
    $tags["school_logo"] = "<img src='$logo' width='100' height='100'/>";
