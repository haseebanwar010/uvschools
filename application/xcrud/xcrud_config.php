...
class Xcrud_config
{
    ...
    // public static $dbname = 'myschool_live'; // Your database name
    ...
    //testing local
    public static $dbname = 'myschool2'; // Your database name
    public static $dbuser = 'root'; // Your database username
    public static $dbpass = ''; // // Your database password
    public static $dbhost = 'localhost'; // Your database host, 'localhost' is default.

    // public static $dbname = 'u847441908_uvschoollive'; // Your database name
    // public static $dbuser = 'u847441908_uvschoollive'; // Your database username
    // public static $dbpass = 'UVschool@12345'; // // Your database password
    // public static $dbhost = 'localhost'; // Your database host, 'localhost' is default.
    ...
    public static $upload_folder_def = '/home/u847441908/domains/uvschools.com/public_html/uploads'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    public static $time_format = 'hh:mm tt'; // jqueryui time format
    public static $php_date_format = 'd/m/Y'; // php date format
    public static $php_time_format = 'h:i a'; // php time format
